...
################## Tree and metadata 
tree_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Caliciviridae_clade/tree/aa_tree/Caliciviridae_clade1_aa_aln_outg.fasta.gap50_clean.fasta.contree"
...
###### Metadata
tip_mdf_brief <- read_delim("/full_path_to/wd/RdRp_scan/analysis/phylo/Caliciviridae_clade/updated_metadata_with_novel_seq1.txt", 
                  delim = "\t")
...
tip_mdf_brief[which(tip_mdf_brief$nt_accession == "OP933694"),]$host_taxon <- "fish intestinal contents"
tip_mdf_brief[which(tip_mdf_brief$nt_accession == "OP514660"),]$host_taxon <- "Ixodida"
tip_mdf_brief[which(tip_mdf_brief$nt_accession == "OM622256"),]$host_taxon <- "river water"
tip_mdf_brief[which(tip_mdf_brief$nt_accession == "OM622257"),]$host_taxon <- "river water"
tip_mdf_brief[which(tip_mdf_brief$nt_accession == "MZ679040"),]$host_taxon <- "lake sediment"
tip_mdf_brief[which(tip_mdf_brief$nt_accession == "MW826415"),]$host_taxon <- "bird feces"
...
tip_mdf_brief$host_taxon1 <- factor(tip_mdf_brief$host_taxon1, ordered = TRUE,
                                   levels = c('Coquillettidia',
                                     ...
                                     'Ixodida',
                                     'Araneae',
                                     'bird anal swab/feces',
                                     'fish intestinal contents',
                                     'river water or lake sediment'
                                     ))
...
tip_mdf_brief[which(tip_mdf_brief$Country %in% 
                      c("Sweden", "Finland", "Spain", "Serbia", "Greece", 
                        "Hungary", "Germany", "Switzerland", "Italy", 
...
#             file = "/full_path_to/wd/RdRp_scan/analysis/phylo/Caliciviridae_clade/clades.tsv",
#             append = F, sep = "\t", col.names = T,
#             row.names = F, quote = F)
# 
# clades_df <- read_delim("/full_path_to/wd/RdRp_scan/analysis/phylo/Caliciviridae_clade/clades.tsv", delim = '\t')
# 
...
# 
# print(ggt2_hm)
ggt2_hm_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Caliciviridae_clade/Caliciviridae_clade1_aa_aln.ggtree_hm.pdf"
ggsave(plot = ggt2_hm, filename = ggt2_hm_file, device = "pdf", width = 10, height = 5, units = "cm")

# ggt2_hm_file_legend <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Caliciviridae_clade/Caliciviridae_clade1_aa_aln.ggtree_hm_legend.pdf"
...
# 
# print(ggt2_hm)
ggt2_hm_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Caliciviridae_clade/Caliciviridae_clade1_aa_aln.ggtree_hm1.pdf"
ggsave(plot = ggt2_hm, filename = ggt2_hm_file, device = "pdf", width = 10, height = 5, units = "cm")
...
print(ggt_sup2_hm)
ggt_sup2_hm_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Caliciviridae_clade/Caliciviridae_clade1_aa_aln.ggtree_hm_supplementary.pdf"
