...
Caliciviridae_clade_df <- read_delim("/full_path_to/wd/RdRp_scan/analysis/phylo/Caliciviridae_clade/Caliciviridae_clade_novel_sequence_data.txt")
...
read_map_df_Caliciviridae_clade <- read_map_df[which(read_map_df$ref_id %in% Caliciviridae_clade_df$contig_id & read_map_df$selected == "yes"),]



read_map_df_Caliciviridae_clade$RdRp_scan_map_consensus_id <- paste0(read_map_df_Caliciviridae_clade$ref_id, "_",
                      read_map_df_Caliciviridae_clade$sample_id, "_RdRpScan_Round1")

read_map_df_Caliciviridae_clade$contig_id <- read_map_df_Caliciviridae_clade$ref_id

consensus_df <- left_join(read_map_df_Caliciviridae_clade, Caliciviridae_clade_df, by  = "contig_id")
...
extracted_consensus_directory <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Caliciviridae_clade/extracted_cons1_renamed/"
dir.create(extracted_consensus_directory)
extracted_orf_nt_directory <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Caliciviridae_clade/extracted_cons1_orf_nt/"
dir.create(extracted_orf_nt_directory)
extracted_orf_aa_directory <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Caliciviridae_clade/extracted_cons1_orf_aa/"
...
write.table(x = consensus_df, file = "/full_path_to/wd/RdRp_scan/analysis/phylo/Caliciviridae_clade/consensus_df.txt", 
...
write.table(x = novel_seq_mdf1, file = "/full_path_to/wd/RdRp_scan/analysis/phylo/Caliciviridae_clade/updated_consensus_df.txt", 
            append = F, quote = F, sep = "\t", row.names = F, col.names = T)
...
# orf_aa_w_stops <- seqinr::read.fasta(file = "/full_path_to/wd/RdRp_scan/analysis/phylo/Caliciviridae_clade/Caliciviridae_orf_aa_manually_corrected.fasta",
#                                      seqtype = "AA")
# extracted_orf_aa_directory1 <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Caliciviridae_clade/extracted_cons1_orf_aa_corrected/"
...
#                       file.out = paste0("/full_path_to/wd/RdRp_scan/analysis/phylo/Caliciviridae_clade/extracted_cons1_orf_aa_corrected/",
#                                         n, ".fasta"))
# }
...
web_blastp_df <- read_delim("/full_path_to/wd/RdRp_scan/analysis/phylo/Caliciviridae_clade/VRTW7W48013-Alignment.txt", 
...
rdrp_scan_clade_accns <- rdrp_scan_clade_accns[which(!rdrp_scan_clade_accns %in% c("Xinjiang_6_picorna_like_virus_12"))]
...
#### Reimport metadata
NCBI_Virus_mdf <- read_csv("/full_path_to/wd/RdRp_scan/analysis/phylo/Caliciviridae_clade/Caliciviridae_metadata_public.csv")
...
write.table(x = selected_mdf_upd_novel, file = "/full_path_to/wd/RdRp_scan/analysis/phylo/Caliciviridae_clade/updated_metadata_with_novel_seq.txt", 
            append = F, quote = F, sep = "\t", row.names = F, col.names = T)
...
#### Put the file here!
cds_fasta_file1 <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Caliciviridae_clade/Caliciviridae_clade_refs_cds_nt.txt"
# cds_fasta_file2 <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Caliciviridae_clade/Caliciviridae_clade_refs_cds_nt2.txt"
...
############################################################################################
############################################################################################
cds_clade_dir <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Caliciviridae_clade/ref_cds_nt"
dir.create(cds_clade_dir)
aa_clade_dir <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Caliciviridae_clade/ref_cds_aa"
...
# gb_parse_metadata_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Caliciviridae_clade/Caliciviridae_to_parse_metadata.gb"
# count = 0
# entry_ends = FALSE
...
write.table(x = selected_mdf_upd_novel1, file = "/full_path_to/wd/RdRp_scan/analysis/phylo/Caliciviridae_clade/updated_metadata_with_novel_seq1.txt", 
            append = F, quote = F, sep = "\t", row.names = F, col.names = T)
...
#### Caliciviridae_clade1 tree
Caliciviridae_clade1_str <- "MZ556273_Sichuan_mosquito_picorna-like_virus
MT753151_Hammarskog_picorna-like_virus
MN513381_Hammarskog_picorna-like_virus
NC_040584_Yongsan_picorna-like_virus_3
OP933694_Fish-associated_picorna-like_virus_4
NC_032222_Hubei_chipolycivirus
Hubei_chipolycivirus_F1028C2F1028
MZ679040_Picornavirales_sp_
OP514660_Graso_virus
MW239492_Picornavirales_sp_
OM622257_Picornavirales_sp_
MZ209812_Guiyang_argiope_bruennichi_polycipivirus_2
OM622256_Picornavirales_sp_
MW239301_Picornavirales_sp_
"
Caliciviridae_clade1 <- str_split(Caliciviridae_clade1_str, "\\s")[[1]]
Caliciviridae_clade1 <- Caliciviridae_clade1[which(!Caliciviridae_clade1 == "")]

Caliciviridae_clade_aa_seq <- seqinr::read.fasta(file = "/full_path_to/wd/RdRp_scan/analysis/phylo/Caliciviridae_clade/aln/aa_seq/Caliciviridae_clade_aa.fasta",
                                seqtype = "AA")
Caliciviridae_clade1_aa_seq <- Caliciviridae_clade_aa_seq[Caliciviridae_clade1]
names(Caliciviridae_clade1_aa_seq)
seqinr::write.fasta(sequences = Caliciviridae_clade1_aa_seq , names =names(Caliciviridae_clade1_aa_seq), 
                    file.out = "/full_path_to/wd/RdRp_scan/analysis/phylo/Caliciviridae_clade/aln/aa_seq/Caliciviridae_clade1_aa.fasta")
##keep the closest sequence as an outgroup
new_outg <- "MW826415_Polycipiviridae_sp_"
new_outg_seq <- Caliciviridae_clade_aa_seq[new_outg]
seqinr::write.fasta(sequences = new_outg_seq , names =names(new_outg_seq), 
                    file.out = paste0("/full_path_to/wd/RdRp_scan/analysis/phylo/Caliciviridae_clade/aln/aa_seq/", 
                                      new_outg, ".fasta"))
