...
Dicistroviridae_clade_df <- read_delim("/full_path_to/wd/RdRp_scan/analysis/phylo/Dicistroviridae_clade/Dicistroviridae_clade_novel_sequence_data.txt")
...
read_map_df_Dicistroviridae_clade <- read_map_df[which(read_map_df$ref_id %in% Dicistroviridae_clade_df$contig_id & read_map_df$selected == "yes"),]



read_map_df_Dicistroviridae_clade$RdRp_scan_map_consensus_id <- paste0(read_map_df_Dicistroviridae_clade$ref_id, "_",
                      read_map_df_Dicistroviridae_clade$sample_id, "_RdRpScan_Round1")

read_map_df_Dicistroviridae_clade$contig_id <- read_map_df_Dicistroviridae_clade$ref_id

consensus_df <- left_join(read_map_df_Dicistroviridae_clade, Dicistroviridae_clade_df, by  = "contig_id")
...
extracted_consensus_directory <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Dicistroviridae_clade/extracted_cons1_renamed/"
dir.create(extracted_consensus_directory)
extracted_orf_nt_directory <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Dicistroviridae_clade/extracted_cons1_orf_nt/"
dir.create(extracted_orf_nt_directory)
extracted_orf_aa_directory <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Dicistroviridae_clade/extracted_cons1_orf_aa/"
...
write.table(x = consensus_df, file = "/full_path_to/wd/RdRp_scan/analysis/phylo/Dicistroviridae_clade/consensus_df.txt", 
...
write.table(x = novel_seq_mdf1, file = "/full_path_to/wd/RdRp_scan/analysis/phylo/Dicistroviridae_clade/updated_consensus_df.txt", 
            append = F, quote = F, sep = "\t", row.names = F, col.names = T)
...
# orf_aa_w_stops <- seqinr::read.fasta(file = "/full_path_to/wd/RdRp_scan/analysis/phylo/Dicistroviridae_clade/Dicistroviridae_orf_aa_manually_corrected.fasta",
#                                      seqtype = "AA")
# extracted_orf_aa_directory1 <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Dicistroviridae_clade/extracted_cons1_orf_aa_corrected/"
...
#                       file.out = paste0("/full_path_to/wd/RdRp_scan/analysis/phylo/Dicistroviridae_clade/extracted_cons1_orf_aa_corrected/",
#                                         n, ".fasta"))
# }
...
web_blastp_df <- read_delim("/full_path_to/wd/RdRp_scan/analysis/phylo/Dicistroviridae_clade/VFXKJB7M016-Alignment.txt", 
...
rdrp_scan_clade_accns <- rdrp_scan_clade_accns[which(!rdrp_scan_clade_accns %in% c("Xinjiang_5_picorna_like_virus_3", 
                                                                                   "Hubei_triatovirus_2", 
                                                                                   "Jiangsu_2_dicistro_like_virus_1",
                                                                                   "Hubei_2_dicistro_like_virus_2",
                                                                                   "Sichuan_apara_like_virus_2",
                                                                                   "Yunnan_2_dicistro_like_virus"))]

refs <- sort(unique(c(blastp_df2$sseqid, rdrp_scan_clade_accns, web_blastp_df$sseqid)))
refs <- str_remove(refs, "\\.[[:digit:]]$")
# refs[which(refs == "Henan_orthoDicistro_like_virus_1")] <- "QYF49524"
...
#### Reimport metadata
NCBI_Virus_mdf <- read_csv("/full_path_to/wd/RdRp_scan/analysis/phylo/Dicistroviridae_clade/Dicistroviridae_metadata_public.csv")
...
write.table(x = selected_mdf_upd_novel, file = "/full_path_to/wd/RdRp_scan/analysis/phylo/Dicistroviridae_clade/updated_metadata_with_novel_seq.txt", 
            append = F, quote = F, sep = "\t", row.names = F, col.names = T)
...
#### Put the file here!
cds_fasta_file1 <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Dicistroviridae_clade/Dicistroviridae_clade_refs_cds_nt.txt"
# cds_fasta_file2 <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Dicistroviridae_clade/Dicistroviridae_clade_refs_cds_nt2.txt"
...
############################################################################################
############################################################################################
cds_clade_dir <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Dicistroviridae_clade/ref_cds_nt"
dir.create(cds_clade_dir)
aa_clade_dir <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Dicistroviridae_clade/ref_cds_aa"
...
# gb_parse_metadata_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Dicistroviridae_clade/Dicistroviridae_to_parse_metadata.gb"
# count = 0
# entry_ends = FALSE
...
write.table(x = selected_mdf_upd_novel1, file = "/full_path_to/wd/RdRp_scan/analysis/phylo/Dicistroviridae_clade/updated_metadata_with_novel_seq1.txt", 
            append = F, quote = F, sep = "\t", row.names = F, col.names = T)
...
### 009336627 from human cell line
...
#### Dicistroviridae_clade1 tree
Dicistroviridae_clade1_str <- "MW434105_Wuhan_insect_virus_33
KX884304_Wuhan_insect_virus_33
NC_033722_Wuhan_insect_virus_33
Wuhan_insect_virus_33_F1452C2F1452
MW834591_Aphis_glycines_virus
MZ209781_Wuhan_insect_virus_33
MN784058_Wuhan_insect_virus_33
"
Dicistroviridae_clade1 <- str_split(Dicistroviridae_clade1_str, "\\s")[[1]]
Dicistroviridae_clade1 <- Dicistroviridae_clade1[which(!Dicistroviridae_clade1 == "")]

Dicistroviridae_clade_aa_seq <- seqinr::read.fasta(file = "/full_path_to/wd/RdRp_scan/analysis/phylo/Dicistroviridae_clade/aln/aa_seq/Dicistroviridae_clade_aa.fasta",
                                seqtype = "AA")
Dicistroviridae_clade1_aa_seq <- Dicistroviridae_clade_aa_seq[Dicistroviridae_clade1]
names(Dicistroviridae_clade1_aa_seq)
seqinr::write.fasta(sequences = Dicistroviridae_clade1_aa_seq , names =names(Dicistroviridae_clade1_aa_seq), 
                    file.out = "/full_path_to/wd/RdRp_scan/analysis/phylo/Dicistroviridae_clade/aln/aa_seq/Dicistroviridae_clade1_aa.fasta")
##keep the closest sequence as an outgroup
new_outg <- "JF423195_Big_Sioux_River_virus"
new_outg_seq <- Dicistroviridae_clade_aa_seq[new_outg]
seqinr::write.fasta(sequences = new_outg_seq , names =names(new_outg_seq), 
                    file.out = paste0("/full_path_to/wd/RdRp_scan/analysis/phylo/Dicistroviridae_clade/aln/aa_seq/", 
                                      new_outg, ".fasta"))
