...
################## Tree and metadata 
tree_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Ghabrivirales_clade/tree/aa_tree/Ghabrivirales_clade4_aa_aln_outg.fasta.gap50_clean.fasta.contree"
...
###### Metadata
tip_mdf_brief <- read_delim("/full_path_to/wd/RdRp_scan/analysis/phylo/Ghabrivirales_clade/updated_metadata_with_novel_seq1.txt", 
                  delim = "\t")
...
# gb_parse_gb_parsed_metadata_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Ghabrivirales_clade/Ghabrivirales_clade4_to_parse_metadata.gb"
# count = 0
# entry_ends = FALSE
# Location <- NULL
# host_taxon <- NULL
...
# 
# write.table(file = "/full_path_to/wd/RdRp_scan/analysis/phylo/Ghabrivirales_clade/Ghabrivirales_clade4_gb_parsed_metadata.txt",
#             x = gb_parsed_metadata, sep = "\t",append = F, quote = F,row.names = F, col.names = T)

gb_parsed_metadata <- read_delim("/full_path_to/wd/RdRp_scan/analysis/phylo/Ghabrivirales_clade/Ghabrivirales_clade4_gb_parsed_metadata.txt",
                                 delim = "\t")
...
tip_mdf_brief[which(tip_mdf_brief$nt_accession == 'MZ218553'),]$host_taxon <- 'soil'
tip_mdf_brief[which(tip_mdf_brief$nt_accession == 'MZ218554'),]$host_taxon <- 'soil'
tip_mdf_brief[which(tip_mdf_brief$nt_accession == 'MZ218584'),]$host_taxon <- 'soil'
tip_mdf_brief[which(tip_mdf_brief$nt_accession == 'MZ218629'),]$host_taxon <- 'soil'
tip_mdf_brief[which(tip_mdf_brief$nt_accession == 'MZ218642'),]$host_taxon <- 'soil'
tip_mdf_brief[which(tip_mdf_brief$nt_accession == 'MZ218643'),]$host_taxon <- 'Chicken feces'
tip_mdf_brief[which(tip_mdf_brief$nt_accession == 'MZ218646'),]$host_taxon <- 'sediment'
tip_mdf_brief[which(tip_mdf_brief$nt_accession == 'MZ218664'),]$host_taxon <- 'soil'
tip_mdf_brief[which(tip_mdf_brief$nt_accession == 'MZ218667'),]$host_taxon <- 'sediment'
...
tip_mdf_brief[which(tip_mdf_brief$host_taxon1 %in% c("Sphenodon", "Chicken")), ]$host_taxon1 <- "reptile/bird feces/swab"
tip_mdf_brief[which(tip_mdf_brief$host_taxon1 %in% c("sediment", "soil")), ]$host_taxon1 <- "soil/sediment"
...
# tip_mdf_brief[which(tip_mdf_brief$host_taxon1 %in% c("Larvivora", "bird feces", "Phylloscopus", "Cairina")), ]$host_taxon1 <- "bird anal swab/feces"
...
#             file = "/full_path_to/wd/RdRp_scan/analysis/phylo/Ghabrivirales_clade/clades.tsv",
#             append = F, sep = "\t", col.names = T,
#             row.names = F, quote = F)
# 
# clades_df <- read_delim("/full_path_to/wd/RdRp_scan/analysis/phylo/Ghabrivirales_clade/clades.tsv", delim = '\t')
# 
...
# 
# print(ggt2_hm)
ggt2_hm_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Ghabrivirales_clade/Ghabrivirales_clade4_aa_aln.ggtree_hm.pdf"
ggsave(plot = ggt2_hm, filename = ggt2_hm_file, device = "pdf", width = 20, height = 14, units = "cm")

# ggt2_hm_file_legend <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Ghabrivirales_clade/Ghabrivirales_clade4_aa_aln.ggtree_hm_legend.pdf"
...
# 
# print(ggt2_hm)
ggt2_hm_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Ghabrivirales_clade/Ghabrivirales_clade4_aa_aln.ggtree_hm1.pdf"
...
print(ggt_sup2_hm)
ggt_sup2_hm_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Ghabrivirales_clade/Ghabrivirales_clade4_aa_aln.ggtree_hm_supplementary.pdf"
