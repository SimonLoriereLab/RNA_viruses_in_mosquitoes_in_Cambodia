...
################## Tree and metadata 
tree_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Ghabrivirales_clade/tree/aa_tree/Ghabrivirales_clade5_aa_aln_outg.fasta.gap50_clean.fasta.contree"
...
# gb_parse_gb_parsed_metadata_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Ghabrivirales_clade/Ghabrivirales_clade5_to_parse_metadata.gb"
# count = 0
# entry_ends = FALSE
# Location <- NULL
# host_taxon <- NULL
...
# 
# write.table(file = "/full_path_to/wd/RdRp_scan/analysis/phylo/Ghabrivirales_clade/Ghabrivirales_clade5_gb_parsed_metadata.txt",
#             x = gb_parsed_metadata, sep = "\t",append = F, quote = F,row.names = F, col.names = T)

gb_parsed_metadata <- read_delim("/full_path_to/wd/RdRp_scan/analysis/phylo/Ghabrivirales_clade/Ghabrivirales_clade5_gb_parsed_metadata.txt",
                                 delim = "\t")
...
tip_mdf_brief[which(tip_mdf_brief$nt_accession == 'MZ218677'),]$host_taxon <- 'soil'
...
# 
# print(ggt2_hm)
ggt2_hm_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Ghabrivirales_clade/Ghabrivirales_clade5_aa_aln.ggtree_hm.pdf"
ggsave(plot = ggt2_hm, filename = ggt2_hm_file, device = "pdf", width = 20, height = 14, units = "cm")

# ggt2_hm_file_legend <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Ghabrivirales_clade/Ghabrivirales_clade5_aa_aln.ggtree_hm_legend.pdf"
...
# 
# print(ggt2_hm)
ggt2_hm_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Ghabrivirales_clade/Ghabrivirales_clade5_aa_aln.ggtree_hm1.pdf"
...
print(ggt_sup2_hm)
ggt_sup2_hm_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Ghabrivirales_clade/Ghabrivirales_clade5_aa_aln.ggtree_hm_supplementary.pdf"
