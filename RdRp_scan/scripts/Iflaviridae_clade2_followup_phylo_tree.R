...
################## Tree and metadata 
tree_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Iflaviridae_clade/tree/aa_tree/Iflaviridae_clade2_aa_aln_outg.fasta.gap50_clean.fasta.contree"
...
tip_mdf_brief[which(tip_mdf_brief$nt_accession == "ON955110"),]$host_taxon <- "Ochlerotatus caspius"
tip_mdf_brief[which(tip_mdf_brief$nt_accession == "ON955111"),]$host_taxon <- "Ochlerotatus caspius"
tip_mdf_brief[which(tip_mdf_brief$nt_accession == "ON955112"),]$host_taxon <- "Ochlerotatus caspius"
tip_mdf_brief[which(tip_mdf_brief$nt_accession == "MZ202266"),]$host_taxon <- "Culex"
tip_mdf_brief[which(tip_mdf_brief$nt_accession == "OM622379"),]$host_taxon <- "water"
tip_mdf_brief[which(tip_mdf_brief$nt_accession == "MK440624"),]$host_taxon <- "Culex"
...
# 
# print(ggt2_hm)
ggt2_hm_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Iflaviridae_clade/Iflaviridae_clade2_aa_aln.ggtree_hm.pdf"
ggsave(plot = ggt2_hm, filename = ggt2_hm_file, device = "pdf", width = 10, height = 14, units = "cm")

# ggt2_hm_file_legend <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Iflaviridae_clade/Iflaviridae_clade2_aa_aln.ggtree_hm_legend.pdf"
...
# 
# print(ggt2_hm)
ggt2_hm_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Iflaviridae_clade/Iflaviridae_clade2_aa_aln.ggtree_hm1.pdf"
...
print(ggt_sup2_hm)
ggt_sup2_hm_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Iflaviridae_clade/Iflaviridae_clade2_aa_aln.ggtree_hm_supplementary.pdf"
