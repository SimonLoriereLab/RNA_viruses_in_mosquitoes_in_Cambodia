...
################## Tree and metadata 
tree_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Iflaviridae_clade/tree/aa_tree/Iflaviridae_clade3_aa_aln_outg.fasta.gap50_clean.fasta.contree"
...
###### Metadata
tip_mdf_brief <- read_delim("/full_path_to/wd/RdRp_scan/analysis/phylo/Iflaviridae_clade/updated_metadata_with_novel_seq1.txt", 
                  delim = "\t")
...
tip_mdf_brief[which(tip_mdf_brief$nt_accession == "OL700170"),]$host_taxon <- "Culex pipiens"
tip_mdf_brief[which(tip_mdf_brief$nt_accession == "OL700171"),]$host_taxon <- "Culex pipiens"
tip_mdf_brief[which(tip_mdf_brief$nt_accession == "OL700172"),]$host_taxon <- "Culex pipiens"
tip_mdf_brief[which(tip_mdf_brief$nt_accession == "MK440627"),]$host_taxon <- "Culex"
...
tip_mdf_brief[which(tip_mdf_brief$host_taxon1 %in% c("Culex", "Aedes")),]$host_taxon1 <- tip_mdf_brief[which(tip_mdf_brief$host_taxon1 %in% c("Culex", "Aedes")),]$host_taxon
tip_mdf_brief[which(str_detect(tip_mdf_brief$host_taxon1, "Culex sp [[:print:]]+")),]$host_taxon1 <- "Culex"
...
#             file = "/full_path_to/wd/RdRp_scan/analysis/phylo/Iflaviridae_clade/clades.tsv",
#             append = F, sep = "\t", col.names = T,
#             row.names = F, quote = F)
# 
# clades_df <- read_delim("/full_path_to/wd/RdRp_scan/analysis/phylo/Iflaviridae_clade/clades.tsv", delim = '\t')
# 
...
ggt2_hm <- ggt2_hm + scale_fill_manual(breaks=c(# 'Anopheles',
                                                ...
                                                # 'Culiseta',
  'Culex pipiens','Culex pseudovishnui','Culex tarsalis',
                                                'Culex',
                                                # 'Psorophora',
                                                # 'Uranotaenia',
...
# 
# print(ggt2_hm)
ggt2_hm_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Iflaviridae_clade/Iflaviridae_clade3_aa_aln.ggtree_hm.pdf"
ggsave(plot = ggt2_hm, filename = ggt2_hm_file, device = "pdf", width = 10, height = 14, units = "cm")

# ggt2_hm_file_legend <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Iflaviridae_clade/Iflaviridae_clade3_aa_aln.ggtree_hm_legend.pdf"
...
# 
# print(ggt2_hm)
ggt2_hm_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Iflaviridae_clade/Iflaviridae_clade3_aa_aln.ggtree_hm1.pdf"
...
print(ggt_sup2_hm)
ggt_sup2_hm_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Iflaviridae_clade/Iflaviridae_clade3_aa_aln.ggtree_hm_supplementary.pdf"
