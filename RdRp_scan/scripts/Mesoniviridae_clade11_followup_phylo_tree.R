...
################## Tree and metadata 
tree_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Mesoniviridae_clade/tree/aa_tree/Mesoniviridae_clade11_aa_aln_outg.fasta.gap50_clean.fasta.contree"
...
###### Metadata
tip_mdf_brief <- read_delim("/full_path_to/wd/RdRp_scan/analysis/phylo/Mesoniviridae_clade/updated_metadata_with_novel_seq1.txt", 
                  delim = "\t")
...
tip_mdf_brief[which(tip_mdf_brief$nt_accession == "NC_036586"),]$host_taxon <- "na"
tip_mdf_brief[which(tip_mdf_brief$nt_accession == "MT514348"),]$host_taxon <- "Culicidae"
tip_mdf_brief[which(tip_mdf_brief$nt_accession == "MT514349"),]$host_taxon <- "Culicidae"
tip_mdf_brief[which(tip_mdf_brief$nt_accession == "MT514350"),]$host_taxon <- "Culicidae"
tip_mdf_brief[which(tip_mdf_brief$nt_accession == "MT514351"),]$host_taxon <- "Culicidae"
tip_mdf_brief[which(tip_mdf_brief$nt_accession == "MN609866"),]$host_taxon <- "Leveillula taurica"
tip_mdf_brief[which(tip_mdf_brief$nt_accession == "MT096515"),]$host_taxon <- "Diptera"
...
#                                                      "Perina", "Plutella", "Dorylus", "Ectropis")), ]$host_taxon1 <- "Insecta (-Culicidae)"
# 
...
tip_mdf_brief$host_taxon1 <- factor(tip_mdf_brief$host_taxon1, ordered = TRUE,
                                   levels = c('Mansonia', 'Coquillettidia', 
                                              'Culex australicus', 'Culex pipiens', 'Culex quinquefasciatus', 'Culex vishnui',
                                     'Culex',
                                     'Uranotaenia',
                                     'Psorophora',
                                              'Aedes',
...
#             file = "/full_path_to/wd/RdRp_scan/analysis/phylo/Mesoniviridae_clade/clades.tsv",
#             append = F, sep = "\t", col.names = T,
#             row.names = F, quote = F)
# 
# clades_df <- read_delim("/full_path_to/wd/RdRp_scan/analysis/phylo/Mesoniviridae_clade/clades.tsv", delim = '\t')
# 
...
# 
# print(ggt2_hm)
ggt2_hm_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Mesoniviridae_clade/Mesoniviridae_clade11_aa_aln.ggtree_hm.pdf"
ggsave(plot = ggt2_hm, filename = ggt2_hm_file, device = "pdf", width = 20, height = 14, units = "cm")

# ggt2_hm_file_legend <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Mesoniviridae_clade/Mesoniviridae_clade11_aa_aln.ggtree_hm_legend.pdf"
...
ggt2_hm <- gheatmap(ggt2, genus_matrix, offset=0.2, width=1.5, font.size=2,
                    colnames_angle=-90, hjust=0)
...
ggt2_hm <- ggt2_hm + geom_point(data = ggt2_hm$data[which(!is.na(ggt2_hm$data$novel_seq)),],
                                aes( x = (extracted_xlims[2] - 0.1), y = y), 
                                color = "black",
                                size=1, shape = 8)



ggt2_hm <- ggt2_hm + xlim((extracted_xlims[1]), (extracted_xlims[2]+0.01))
...
# 
# print(ggt2_hm)
ggt2_hm_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Mesoniviridae_clade/Mesoniviridae_clade11_aa_aln.ggtree_hm1.pdf"
...
print(ggt_sup2_hm)
ggt_sup2_hm_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Mesoniviridae_clade/Mesoniviridae_clade11_aa_aln.ggtree_hm_supplementary.pdf"
