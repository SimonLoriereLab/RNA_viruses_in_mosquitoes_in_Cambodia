...
Mesoniviridae_clade_df <- read_delim("/full_path_to/wd/RdRp_scan/analysis/phylo/Mesoniviridae_clade/Mesoniviridae_clade_novel_sequence_data.txt")
...
read_map_df_Mesoniviridae_clade <- read_map_df[which(read_map_df$ref_id %in% Mesoniviridae_clade_df$contig_id & read_map_df$selected == "yes"),]



read_map_df_Mesoniviridae_clade$RdRp_scan_map_consensus_id <- paste0(read_map_df_Mesoniviridae_clade$ref_id, "_",
                      read_map_df_Mesoniviridae_clade$sample_id, "_RdRpScan_Round1")

read_map_df_Mesoniviridae_clade$contig_id <- read_map_df_Mesoniviridae_clade$ref_id

consensus_df <- left_join(read_map_df_Mesoniviridae_clade, Mesoniviridae_clade_df, by  = "contig_id")
...
extracted_consensus_directory <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Mesoniviridae_clade/extracted_cons1_renamed/"
dir.create(extracted_consensus_directory)
extracted_orf_nt_directory <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Mesoniviridae_clade/extracted_cons1_orf_nt/"
dir.create(extracted_orf_nt_directory)
extracted_orf_aa_directory <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Mesoniviridae_clade/extracted_cons1_orf_aa/"
...
write.table(x = consensus_df, file = "/full_path_to/wd/RdRp_scan/analysis/phylo/Mesoniviridae_clade/consensus_df.txt", 
...
write.table(x = novel_seq_mdf1, file = "/full_path_to/wd/RdRp_scan/analysis/phylo/Mesoniviridae_clade/updated_consensus_df.txt", 
            append = F, quote = F, sep = "\t", row.names = F, col.names = T)
...
orf_aa_w_stops <- seqinr::read.fasta(file = "/full_path_to/wd/RdRp_scan/analysis/phylo/Mesoniviridae_clade/Mesoniviridae_orf_aa_manually_corrected.fasta",
                                     seqtype = "AA")
extracted_orf_aa_directory1 <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Mesoniviridae_clade/extracted_cons1_orf_aa_corrected/"
...
for (n in names(orf_aa_w_stops)){
  ...
  seqinr::write.fasta(sequences = s2, names = n,
                      file.out = paste0("/full_path_to/wd/RdRp_scan/analysis/phylo/Mesoniviridae_clade/extracted_cons1_orf_aa_corrected/",
                                        n, ".fasta"))
}
...
web_blastp_df <- read_delim("/full_path_to/wd/RdRp_scan/analysis/phylo/Mesoniviridae_clade/VUBRHKCU013-Alignment.txt", 
...
# rdrp_scan_clade_accns <- rdrp_scan_clade_accns[which(!str_detect(rdrp_scan_clade_accns, "ya20"))] ### remove ones for which accessions not found
# rdrp_scan_clade_accns <- rdrp_scan_clade_accns[which(!str_detect(rdrp_scan_clade_accns, "JA[[:alnum:]]+_1_JA[[:alnum:]]+"))] ### remove ones for which accessions not found
...
# refs[which(refs == "Henan_orthoCalici_like_virus_1")] <- "QYF49524"
...
#### Reimport metadata
NCBI_Virus_mdf <- read_csv("/full_path_to/wd/RdRp_scan/analysis/phylo/Mesoniviridae_clade/Mesoniviridae_metadata_public.csv")
...
write.table(x = selected_mdf_upd_novel, file = "/full_path_to/wd/RdRp_scan/analysis/phylo/Mesoniviridae_clade/updated_metadata_with_novel_seq.txt", 
            append = F, quote = F, sep = "\t", row.names = F, col.names = T)
...
#### Put the file here!
cds_fasta_file1 <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Mesoniviridae_clade/Mesoniviridae_clade_refs_cds_nt.txt"
# cds_fasta_file2 <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Mesoniviridae_clade/Mesoniviridae_clade_refs_cds_nt2.txt"
...
############################################################################################
############################################################################################
cds_clade_dir <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Mesoniviridae_clade/ref_cds_nt"
dir.create(cds_clade_dir)
aa_clade_dir <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Mesoniviridae_clade/ref_cds_aa"
...
# gb_parse_metadata_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Mesoniviridae_clade/Mesoniviridae_to_parse_metadata.gb"
# count = 0
# entry_ends = FALSE
...
write.table(x = selected_mdf_upd_novel1, file = "/full_path_to/wd/RdRp_scan/analysis/phylo/Mesoniviridae_clade/updated_metadata_with_novel_seq1.txt", 
            append = F, quote = F, sep = "\t", row.names = F, col.names = T)
...
#### Mesoniviridae_clade1 tree
Mesoniviridae_clade1_str <- "Nam_Dinh_virus_F1576C2C25945C25414C25622C8C26117C15F1576
KF522691_Alphamesonivirus_1
OL700077_Alphamesonivirus_1
KF771866_Alphamesonivirus_1
NC_015874_Alphamesonivirus_1
KC807170_Alphamesonivirus_1
MT514349_Alphamesonivirus_1
MT514351_Alphamesonivirus_1
MT514350_Alphamesonivirus_1
MF176279_Alphamesonivirus_1
MT514348_Alphamesonivirus_1
KU095838_Alphamesonivirus_1
MH520100_Alphamesonivirus_1
MH520106_Alphamesonivirus_1
MH520103_Alphamesonivirus_1
MH520101_Alphamesonivirus_1
MK440619_Alphamesonivirus_1
MH215275_Alphamesonivirus_1
MW699044_Alphamesonivirus_1
OV054251_Alphamesonivirus_1
MN101550_Alphamesonivirus_1
MF281710_Alphamesonivirus_1
MT096515_Alphamesonivirus_1
KC807175_Alphamesonivirus_1
KC807178_Alphamesonivirus_1
KC807176_Alphamesonivirus_1
KC807177_Alphamesonivirus_1
KJ475851_Alphamesonivirus_1
MH443059_Alphamesonivirus_1
MH188022_Alphamesonivirus_1
MH719099_Alphamesonivirus_1
MH188023_Alphamesonivirus_1
LC497422_Odorna_virus
HM746600_Alphamesonivirus_1
NC_015668_Alphamesonivirus_1
LC497421_Alphamesonivirus_1
NC_036586_Alphamesonivirus_10
KC807166_Alphamesonivirus_1
MF158348_Bontang_Baru_virus
KC807167_Alphamesonivirus_1
NC_038296_Alphamesonivirus_2
KC807172_Alphamesonivirus_1
KC807174_Alphamesonivirus_1
NC_038297_Alphamesonivirus_3
MZ358853_Alphamesonivirus_4
NC_023986_Alphamesonivirus_4
MT522184_Alphamesonivirus_sp_
MT522182_Alphamesonivirus_sp_
MT522183_Alphamesonivirus_sp_
NC_020899_Alphamesonivirus_2
JQ996713_Alphamesonivirus_1
JQ996715_Alphamesonivirus_1
JQ996714_Alphamesonivirus_1
JQ996712_Alphamesonivirus_1
LC609729_Alphamesonivirus_1
KC768950_Moumo_virus
NC_020901_Alphamesonivirus_4
NC_020900_Alphamesonivirus_3
NC_043488_Alphamesonivirus_7
NC_043489_Alphamesonivirus_6
KY369959_Alphamesonivirus_11
NC_040534_Alphamesonivirus_11
MT070763_Alphamesonivirus_11
"
Mesoniviridae_clade1 <- str_split(Mesoniviridae_clade1_str, "\\s")[[1]]
Mesoniviridae_clade1 <- Mesoniviridae_clade1[which(!Mesoniviridae_clade1 == "")]

Mesoniviridae_clade_aa_seq <- seqinr::read.fasta(file = "/full_path_to/wd/RdRp_scan/analysis/phylo/Mesoniviridae_clade/aln/aa_seq/Mesoniviridae_clade_aa.fasta",
                                seqtype = "AA")
Mesoniviridae_clade1_aa_seq <- Mesoniviridae_clade_aa_seq[Mesoniviridae_clade1]
names(Mesoniviridae_clade1_aa_seq)
seqinr::write.fasta(sequences = Mesoniviridae_clade1_aa_seq , names =names(Mesoniviridae_clade1_aa_seq),
                    file.out = "/full_path_to/wd/RdRp_scan/analysis/phylo/Mesoniviridae_clade/aln/aa_seq/Mesoniviridae_clade1_aa.fasta")
##keep the closest sequence as an outgroup
new_outg <- "MN609866_Leveillula_taurica_associated_alphamesonivirus_1"
new_outg_seq <- Mesoniviridae_clade_aa_seq[new_outg]
seqinr::write.fasta(sequences = new_outg_seq , names =names(new_outg_seq),
                    file.out = paste0("/full_path_to/wd/RdRp_scan/analysis/phylo/Mesoniviridae_clade/aln/aa_seq/",
                                      new_outg, ".fasta"))


####### Zooming in on different clades
#### Mesoniviridae_clade11 tree
Mesoniviridae_clade11_str <- "Nam_Dinh_virus_F1576C2C25945C25414C25622C8C26117C15F1576
MT514349_Alphamesonivirus_1
MT514351_Alphamesonivirus_1
KF522691_Alphamesonivirus_1
JQ996713_Alphamesonivirus_1
...
NC_015668_Alphamesonivirus_1
"
Mesoniviridae_clade11 <- str_split(Mesoniviridae_clade11_str, "\\s")[[1]]
Mesoniviridae_clade11 <- Mesoniviridae_clade11[which(!Mesoniviridae_clade11 == "")]

Mesoniviridae_clade_aa_seq <- seqinr::read.fasta(file = "/full_path_to/wd/RdRp_scan/analysis/phylo/Mesoniviridae_clade/aln/aa_seq/Mesoniviridae_clade_aa.fasta",
                                                 seqtype = "AA")
Mesoniviridae_clade11_aa_seq <- Mesoniviridae_clade_aa_seq[Mesoniviridae_clade11]
names(Mesoniviridae_clade11_aa_seq)
seqinr::write.fasta(sequences = Mesoniviridae_clade11_aa_seq , names =names(Mesoniviridae_clade11_aa_seq),
                    file.out = "/full_path_to/wd/RdRp_scan/analysis/phylo/Mesoniviridae_clade/aln/aa_seq/Mesoniviridae_clade11_aa.fasta")
##keep the closest sequence as an outgroup
new_outg <- "NC_036586_Alphamesonivirus_10"
new_outg_seq <- Mesoniviridae_clade_aa_seq[new_outg]
seqinr::write.fasta(sequences = new_outg_seq , names =names(new_outg_seq),
                    file.out = paste0("/full_path_to/wd/RdRp_scan/analysis/phylo/Mesoniviridae_clade/aln/aa_seq/",
                                      new_outg, ".fasta"))
