...
################## Tree and metadata 
tree_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Monjiviricetes_clade/tree/aa_tree/Monjiviricetes_clade2_aa_aln_outg.fasta.gap50_clean.fasta.contree"
...
# gb_parse_gb_parsed_metadata_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Monjiviricetes_clade/Monjiviricetes_clade2_to_parse_metadata.gb"
# count = 0
# entry_ends = FALSE
# Location <- NULL
# host_taxon <- NULL
...
# 
# write.table(file = "/full_path_to/wd/RdRp_scan/analysis/phylo/Monjiviricetes_clade/Monjiviricetes_clade2_gb_parsed_metadata.txt",
#             x = gb_parsed_metadata, sep = "\t",append = F, quote = F,row.names = F, col.names = T)

gb_parsed_metadata <- read_delim("/full_path_to/wd/RdRp_scan/analysis/phylo/Monjiviricetes_clade/Monjiviricetes_clade2_gb_parsed_metadata.txt",
                                 delim = "\t")
...
tip_mdf_brief[which(tip_mdf_brief$nt_accession == 'MH822965'),]$host_taxon <- 'Anopheles marajoara'
...
tip_mdf_brief$host_taxon1 <- factor(tip_mdf_brief$host_taxon1, ordered = TRUE,
                                   levels = c('Anopheles darlingi','Anopheles gambiae','Anopheles marajoara', 'Anopheles peditaeniatus','Anopheles sinensis',
                                              'Anopheles',
                                              'Culiseta',
                                              'Culex australicus','Culex globocoxitus','Culex pipiens','Culex quinquefasciatus','Culex theileri','Culex torrentium','Culex tritaeniorhynchus',
                                              'Culex',
...
tip_mdf_brief[which(tip_mdf_brief$Country %in% 
                      c("Canada", "USA", "Mexico", "Guadeloupe", "Trinidad and Tobago")),
...
tip_mdf_brief[which(tip_mdf_brief$Country %in%
                      c("Ghana", "Gabon", "Liberia", "Senegal", "Burkina Faso")),
...
tip_mdf_brief[which(tip_mdf_brief$Country %in% 
                      c("India", "China", "Malaysia", "Thailand", "Cambodia","South Korea", "Japan", "Australia")),
...
# 
# 
# virus_clade <- c("Bat faecal associated anphe-like virus 1", "Tolviot virus",
#                  "Guadeloupe mosquito mononega-like virus", "XiangYun mono-chu-like virus 8",
#                  "XiangYun mono-chu-like virus 5", "MW452297_Mononegavirales", 
#                  "Prepisiers virus", "Doupovirus australiaense", "Hanko anphevirus",
#                  "Serbia mononega-like virus 1", "Aedes albopictus anphevirus", "Malby virus",
#                  "Enontekio anphevirus 1", "XiangYun mono-chu-like virus 1", "Triniovirus yonagoense",
#                  "Guadeloupe mosquito mononega-like virus", "Joensuu anphevirus", 
#                  "Gambievirus senegalense", "Gambievirus bolahunense", "Bolahun virus variant 1",
#                  "Madalivirus amapaense", "Madalivirus amazonaense", 
#                  "Anphevirus_xinchengense/Xincheng Mosquito Virus",
#                  "Culex mononega-like virus 1", "Gordis virus", "Enontekio anphevirus 2",
#                  "Gylbovirus aagae/Aedes anphevirus")
# 
# clades_df <- tibble(virus_clade)
# clades_df$node <- NA
# 
# clades_df[which(clades_df$virus_clade == "Bat faecal associated anphe-like virus 1"), ]$node <- 91
# clades_df[which(clades_df$virus_clade == "Tolviot virus"), ]$node <- 178
# clades_df[which(clades_df$virus_clade == "Guadeloupe mosquito mononega-like virus"), ]$node <- 86
# clades_df[which(clades_df$virus_clade == "XiangYun mono-chu-like virus 8"), ]$node <- 85
# clades_df[which(clades_df$virus_clade == "XiangYun mono-chu-like virus 5"), ]$node <- 84
# clades_df[which(clades_df$virus_clade == "MW452297_Mononegavirales"), ]$node <- 83
# clades_df[which(clades_df$virus_clade == "Prepisiers virus"), ]$node <- 82
# clades_df[which(clades_df$virus_clade == "Doupovirus australiaense"), ]$node <- 169
# clades_df[which(clades_df$virus_clade == "Hanko anphevirus"), ]$node <- 73
# clades_df[which(clades_df$virus_clade == "Serbia mononega-like virus 1"), ]$node <- 72
# clades_df[which(clades_df$virus_clade == "Aedes albopictus anphevirus"), ]$node <- 165
# clades_df[which(clades_df$virus_clade == "Malby virus"), ]$node <- 63
# clades_df[which(clades_df$virus_clade == "Enontekio anphevirus 1"), ]$node <- 64
# clades_df[which(clades_df$virus_clade == "XiangYun mono-chu-like virus 1"), ]$node <- 62
# clades_df[which(clades_df$virus_clade == "Triniovirus yonagoense"), ]$node <- 157
# clades_df[which(clades_df$virus_clade == "Guadeloupe mosquito mononega-like virus"), ]$node <- 69
# clades_df[which(clades_df$virus_clade == "Joensuu anphevirus"), ]$node <- 160
# clades_df[which(clades_df$virus_clade == "Gambievirus senegalense"), ]$node <- 56
# clades_df[which(clades_df$virus_clade == "Gambievirus bolahunense"), ]$node <- 55
# clades_df[which(clades_df$virus_clade == "Bolahun virus variant 1"), ]$node <- 54
# clades_df[which(clades_df$virus_clade == "Madalivirus amapaense"), ]$node <- 59
# clades_df[which(clades_df$virus_clade == "Madalivirus amazonaense"), ]$node <- 151
# clades_df[which(clades_df$virus_clade == "Anphevirus_xinchengense/Xincheng Mosquito Virus"), ]$node <- 143
# clades_df[which(clades_df$virus_clade == "Culex mononega-like virus 1"), ]$node <- 131
# clades_df[which(clades_df$virus_clade == "Gordis virus"), ]$node <- 137
# clades_df[which(clades_df$virus_clade == "Enontekio anphevirus 2"), ]$node <- 34
# clades_df[which(clades_df$virus_clade == "Gylbovirus aagae/Aedes anphevirus"), ]$node <- 97
# 
# 
# 
...
# 
# clades_df$tip <- FALSE
# clades_df[which(clades_df$virus_clade_essential %in% c("Bat faecal associated anphe-like virus 1",
#                                                        "Guadeloupe mosquito mononega-like virus",
#                                                        "XiangYun mono-chu-like virus 8",
#                                                        "XiangYun mono-chu-like virus 5", 
#                                                        "MW452297_Mononegavirales",
#                                                        "Prepisiers virus",
#                                                        "Serbia mononega-like virus 1",
#                                                        "Malby virus",
#                                                        "Enontekio anphevirus 1", 
#                                                        "XiangYun mono-chu-like virus 1",
#                                                        "Guadeloupe mosquito mononega-like virus",
#                                                        "Gambievirus senegalense",
#                                                        "Gambievirus bolahunense",
#                                                        "Bolahun virus variant 1",
#                                                        "Madalivirus amapaense",
#                                                        "Enontekio anphevirus 2")),]$tip <- TRUE
# 
# 
# 
...
#                           aes( x = (extracted_xlims[2] - 0.53), y = y), 
#                           color = "black",
#                           size=1, shape = 8)
# 
# 
...
# # 
# # print(ggt2_hm)
# ggt2_hm_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Monjiviricetes_clade/Monjiviricetes_clade2_aa_aln.ggtree_hm.pdf"
# ggsave(plot = ggt2_hm, filename = ggt2_hm_file, device = "pdf", width = 10, height = 14, units = "cm")
# 
# # ggt2_hm_file_legend <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Monjiviricetes_clade/Monjiviricetes_clade2_aa_aln.ggtree_hm_legend.pdf"
...
#### Coloring of mosquito genus and region
ggt2_hm <- ggt2_hm + scale_fill_manual(breaks=c('Anopheles darlingi','Anopheles gambiae','Anopheles marajoara', 'Anopheles peditaeniatus','Anopheles sinensis',
                                                'Anopheles',
...
values=c("black","black","black","black","black",
         ...
         "#DDCC77",
         "#392698","#4b32c7","#634dd3", "#7f6dda", "#A89CE6","#9A8CE2","#8D7CDE",
         "#332288",
         # "#dd1c77",
         # "#de2d26",
...
ggt2_hm <- ggt2_hm + scale_color_manual(breaks=c('Anopheles darlingi','Anopheles gambiae','Anopheles marajoara', 'Anopheles peditaeniatus','Anopheles sinensis',
                                                 'Anopheles',
...
# 
# print(ggt2_hm)
ggt2_hm_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Monjiviricetes_clade/Monjiviricetes_clade2_aa_aln.ggtree_hm1.pdf"
...
print(ggt_sup2_hm)
ggt_sup2_hm_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Monjiviricetes_clade/Monjiviricetes_clade2_aa_aln.ggtree_hm_supplementary.pdf"
