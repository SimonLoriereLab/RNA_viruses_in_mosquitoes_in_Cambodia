...
################## Tree and metadata 
tree_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Monjiviricetes_clade/tree/aa_tree/Monjiviricetes_clade5_aa_aln_outg.fasta.gap50_clean.fasta.contree"
...
tip_mdf_brief[which(tip_mdf_brief$nt_accession == "MT240824"),]$host_taxon <- "Nematocera"
tip_mdf_brief[which(tip_mdf_brief$nt_accession == "MT240825"),]$host_taxon <- "Nematocera"
tip_mdf_brief[which(tip_mdf_brief$nt_accession == "MT240827"),]$host_taxon <- "Nematocera"
tip_mdf_brief[which(tip_mdf_brief$nt_accession == "MT240828"),]$host_taxon <- "Nematocera"
...
# tip_mdf_brief$host_taxon1 <- tip_mdf_brief$host_taxon_custom
tip_mdf_brief$host_taxon1 <- tip_mdf_brief$host_genus


sum(is.na(tip_mdf_brief$host_taxon1)) == 0
...
virus_clade <- c("OP589941 Rhabdoviridae", "Almendravirus almendras", 
                 "Almendravirus arboretum/Shanxi Arboretum virus", "Almendravirus balsa",
                 "Almendravirus chico", "Shanxi Armigeres subalbatus rhabdovirus", 
                 "Xiangshan rhabdo-like virus 1", "Almendravirus cootbay", "Poterfers virus",
                 "Almendravirus menghai")

clades_df <- tibble(virus_clade)
clades_df$node <- NA

clades_df[which(clades_df$virus_clade == "OP589941 Rhabdoviridae"), ]$node <- 18
clades_df[which(clades_df$virus_clade == "Almendravirus almendras"), ]$node <- 17
clades_df[which(clades_df$virus_clade == "Almendravirus arboretum/Shanxi Arboretum virus"), ]$node <- 33
clades_df[which(clades_df$virus_clade == "Almendravirus balsa"), ]$node <- 13
clades_df[which(clades_df$virus_clade == "Almendravirus chico"), ]$node <- 12
clades_df[which(clades_df$virus_clade == "Shanxi Armigeres subalbatus rhabdovirus"), ]$node <- 10
clades_df[which(clades_df$virus_clade == "Xiangshan rhabdo-like virus 1"), ]$node <- 11
clades_df[which(clades_df$virus_clade == "Almendravirus cootbay"), ]$node <- 9
clades_df[which(clades_df$virus_clade == "Poterfers virus"), ]$node <- 8
clades_df[which(clades_df$virus_clade == "Almendravirus menghai"), ]$node <- 23
...
clades_df$tip <- FALSE
clades_df[which(clades_df$virus_clade_essential %in% c("OP589941 Rhabdoviridae",
                                                       "Almendravirus almendras",
                                                       "Almendravirus balsa",
                                                       "Almendravirus chico", 
                                                       "Shanxi Armigeres subalbatus rhabdovirus", 
                                                       "Xiangshan rhabdo-like virus 1",
                                                       "Almendravirus cootbay",
                                                       "Poterfers virus")),]$tip <- TRUE
...
# 
# print(ggt2_hm)
ggt2_hm_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Monjiviricetes_clade/Monjiviricetes_clade5_aa_aln.ggtree_hm.pdf"
ggsave(plot = ggt2_hm, filename = ggt2_hm_file, device = "pdf", width = 10, height = 7, units = "cm")

# ggt2_hm_file_legend <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Monjiviricetes_clade/Monjiviricetes_clade5_aa_aln.ggtree_hm_legend.pdf"
...
print(ggt_sup2_hm)
ggt_sup2_hm_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Monjiviricetes_clade/Monjiviricetes_clade5_aa_aln.ggtree_hm_supplementary.pdf"
