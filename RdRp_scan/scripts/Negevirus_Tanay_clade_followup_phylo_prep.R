...
Negevirus_Tanay_clade_df <- read_delim("/full_path_to/wd/RdRp_scan/analysis/phylo/Negevirus_Tanay_clade/Negevirus_Tanay_clade_novel_sequence_data.txt")
...
read_map_df_Negevirus_Tanay_clade <- read_map_df[which(read_map_df$ref_id %in% Negevirus_Tanay_clade_df$contig_id & read_map_df$selected == "yes"),]



read_map_df_Negevirus_Tanay_clade$RdRp_scan_map_consensus_id <- paste0(read_map_df_Negevirus_Tanay_clade$ref_id, "_",
                      read_map_df_Negevirus_Tanay_clade$sample_id, "_RdRpScan_Round1")

read_map_df_Negevirus_Tanay_clade$contig_id <- read_map_df_Negevirus_Tanay_clade$ref_id

consensus_df <- left_join(read_map_df_Negevirus_Tanay_clade, Negevirus_Tanay_clade_df, by  = "contig_id")
...
extracted_consensus_directory <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Negevirus_Tanay_clade/extracted_cons1_renamed/"
dir.create(extracted_consensus_directory)
extracted_orf_nt_directory <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Negevirus_Tanay_clade/extracted_cons1_orf_nt/"
dir.create(extracted_orf_nt_directory)
extracted_orf_aa_directory <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Negevirus_Tanay_clade/extracted_cons1_orf_aa/"
...
write.table(x = consensus_df, file = "/full_path_to/wd/RdRp_scan/analysis/phylo/Negevirus_Tanay_clade/consensus_df.txt", 
...
write.table(x = novel_seq_mdf1, file = "/full_path_to/wd/RdRp_scan/analysis/phylo/Negevirus_Tanay_clade/updated_consensus_df.txt", 
            append = F, quote = F, sep = "\t", row.names = F, col.names = T)
...
# orf_aa_w_stops <- seqinr::read.fasta(file = "/full_path_to/wd/RdRp_scan/analysis/phylo/Negevirus_Tanay_clade/Negevirus_orf_aa_manually_corrected.fasta",
#                                      seqtype = "AA")
# extracted_orf_aa_directory1 <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Negevirus_Tanay_clade/extracted_cons1_orf_aa_corrected/"
...
#                       file.out = paste0("/full_path_to/wd/RdRp_scan/analysis/phylo/Negevirus_Tanay_clade/extracted_cons1_orf_aa_corrected/",
#                                         n, ".fasta"))
# }
...
web_blastp_df <- read_delim("/full_path_to/wd/RdRp_scan/analysis/phylo/Negevirus_Tanay_clade/1PYPASWA016-Alignment (1).txt", 
...
#### Reimport metadata
NCBI_Virus_mdf <- read_csv("/full_path_to/wd/RdRp_scan/analysis/phylo/Negevirus_Tanay_clade/Negevirus_Tanay_metadata_public.csv")
...
write.table(x = selected_mdf_upd_novel, file = "/full_path_to/wd/RdRp_scan/analysis/phylo/Negevirus_Tanay_clade/updated_metadata_with_novel_seq.txt", 
            append = F, quote = F, sep = "\t", row.names = F, col.names = T)
...
# refs <- read_lines("/full_path_to/wd/RdRp_scan/analysis/phylo/Negevirus_Tanay_clade/Negevirus_accessions_viruses.txt")
...
#### Put the file here!
cds_fasta_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Negevirus_Tanay_clade/Negevirus_Tanay_clade_refs_cds_nt.txt"
...
############################################################################################
############################################################################################
cds_clade_dir <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Negevirus_Tanay_clade/ref_cds_nt"
dir.create(cds_clade_dir)
aa_clade_dir <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Negevirus_Tanay_clade/ref_cds_aa"
...
# gb_parse_metadata_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Negevirus_Tanay_clade/Negevirus_to_parse_metadata.gb"
# count = 0
# entry_ends = FALSE
...
write.table(x = selected_mdf_upd_novel1, file = "/full_path_to/wd/RdRp_scan/analysis/phylo/Negevirus_Tanay_clade/updated_metadata_with_novel_seq1.txt", 
            append = F, quote = F, sep = "\t", row.names = F, col.names = T)
...
#### Negevirus_Tanay_clade1 tree
Negevirus_Tanay_clade1_str <- "Tanay_virus_F1530C2F1532
MZ615329_Wallerfield_virus
KM350505_Wallerfield_virus
MZ615321_Feitosa_virus
MZ615326_Feitosa_virus
MF281709_Biggievirus_Mos11
MF281708_Biggievirus_Mos11
KX924639_Biggievirus_Mos11
MH188028_Culex_Biggie-like_virus
KM350507_Wallerfield_virus
MG551501_Tanay_virus
MG551502_Tanay_virus
MG551500_Tanay_virus
MG551503_Tanay_virus
MG551504_Tanay_virus
NC_023440_Wallerfield_virus
ON949943_Dezidougou_virus
KX518836_Wallerfield_virus
MH603566_Biggievirus_Mos11
MK440620_Biggie_virus
NC_035129_Culex_negev-like_virus_3
KF588036_Goutanap_virus
NC_025357_Goutanap_virus
KF588037_Goutanap_virus
LC504569_Goutanap_virus
KM249339_Goutanap_virus
KF588038_Goutanap_virus
KF588039_Goutanap_virus
Tanay_virus_F1530C2F1212
Tanay_virus_F1530C2F1217
KM350506_Wallerfield_virus
MZ615323_Wallerfield_virus
KM350504_Wallerfield_virus
KX518839_Wallerfield_virus
JQ675604_Dezidougou_virus
KY968698_Dezidougou_virus
JQ675606_Santana_virus
LC103139_Bustos_virus
MG673930_Tanay_virus
Tanay_virus_F1530C2F1219
Tanay_virus_F1530C2F1533
Tanay_virus_F1530C2F1215
Tanay_virus_F1530C2F1530
KX518833_Wallerfield_virus
KX518758_Biratnagar_virus
NC_034153_Biratnagar_virus
KX518837_Wallerfield_virus
MK959117_Wallerfield_virus
KX518823_Wallerfield_virus
KX518829_Wallerfield_virus
KX518832_Wallerfield_virus
KX518835_Wallerfield_virus
MH719095_Uxmal_virus
OP264896_Dezidougou_virus
MT096525_Dezidougou_virus
ON949944_Kustavi_negevirus
MN101546_Bustos_virus
MK959116_Agua_Salud_negevirus
MG551506_Tanay_virus
MG551505_Tanay_virus
KF425263_Tanay_virus
NC_024071_Tanay_virus
KF425262_Tanay_virus
MN661084_Atrato_Nege-like_virus_1
"
Negevirus_Tanay_clade1 <- str_split(Negevirus_Tanay_clade1_str, "\\s")[[1]]
Negevirus_Tanay_clade1 <- Negevirus_Tanay_clade1[which(!Negevirus_Tanay_clade1 == "")]

Negevirus_Tanay_clade_aa_seq <- seqinr::read.fasta(file = "/full_path_to/wd/RdRp_scan/analysis/phylo/Negevirus_Tanay_clade/aln/aa_seq/Negevirus_Tanay_clade_aa.fasta",
                                seqtype = "AA")
Negevirus_Tanay_clade1_aa_seq <- Negevirus_Tanay_clade_aa_seq[Negevirus_Tanay_clade1]
names(Negevirus_Tanay_clade1_aa_seq)
seqinr::write.fasta(sequences = Negevirus_Tanay_clade1_aa_seq , names =names(Negevirus_Tanay_clade1_aa_seq),
                    file.out = "/full_path_to/wd/RdRp_scan/analysis/phylo/Negevirus_Tanay_clade/aln/aa_seq/Negevirus_Tanay_clade1_aa.fasta")
##keep the closest sequence as an outgroup
new_outg <- "OK491483_Xiangshan_martelli-like_virus_1"
new_outg_seq <- Negevirus_Tanay_clade_aa_seq[new_outg]
seqinr::write.fasta(sequences = new_outg_seq , names =names(new_outg_seq),
                    file.out = paste0("/full_path_to/wd/RdRp_scan/analysis/phylo/Negevirus_Tanay_clade/aln/aa_seq/",
                                      new_outg, ".fasta"))
