...
################## Tree and metadata 
tree_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Negevirus_Tanay_clade/tree/aa_tree/Negevirus_Tanay_clade1_aa_aln_outg.fasta.gap50_clean.fasta.contree"
...
tip_df$tip_labels <- str_replace_all(tip_df$tip_labels, "'", "_")

###### Metadata
tip_mdf_brief <- read_delim("/full_path_to/wd/RdRp_scan/analysis/phylo/Negevirus_Tanay_clade/updated_metadata_with_novel_seq1.txt", 
                  delim = "\t")

tip_mdf_brief$nt_seq_ID <- str_replace_all(tip_mdf_brief$nt_seq_ID, "'", "_")
...
# gb_parse_gb_parsed_metadata_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Negevirus_Tanay_clade/Negevirus_Tanay_clade1_to_parse_metadata.gb"
# count = 0
# entry_ends = FALSE
# Location <- NULL
# host_taxon <- NULL
...
# 
# write.table(file = "/full_path_to/wd/RdRp_scan/analysis/phylo/Negevirus_Tanay_clade/Negevirus_Tanay_clade1_gb_parsed_metadata.txt",
#             x = gb_parsed_metadata, sep = "\t",append = F, quote = F,row.names = F, col.names = T)

gb_parsed_metadata <- read_delim("/full_path_to/wd/RdRp_scan/analysis/phylo/Negevirus_Tanay_clade/Negevirus_Tanay_clade1_gb_parsed_metadata.txt",
                                 delim = "\t")
...
# tip_mdf_brief[which(tip_mdf_brief$nt_accession == 'NC_034153'),]$host_taxon <- ''
# tip_mdf_brief[which(tip_mdf_brief$nt_accession == 'MT096525'),]$host_taxon <- ''
# tip_mdf_brief[which(tip_mdf_brief$nt_accession == 'KX518758'),]$host_taxon <- ''
# tip_mdf_brief[which(tip_mdf_brief$nt_accession == 'KX518837'),]$host_taxon <- ''
# tip_mdf_brief[which(tip_mdf_brief$nt_accession == 'KX518839'),]$host_taxon <- ''
...
# tip_mdf_brief[which(str_detect(tip_mdf_brief$host_taxon1, "Cx. (Cux.) species")),]$host_taxon1 <- "Culex"
tip_mdf_brief[which(str_detect(tip_mdf_brief$host_taxon1, "Cx")),]$host_taxon1 <- "Culex"
...
tip_mdf_brief[which(tip_mdf_brief$Country %in% 
                      c("Sweden", "Finland", "Spain", "Serbia", "Greece", 
                        ...
                        "Austria",  "Slovakia", "Russia", "France", "United Kingdom")),
]$Region <- "Europe"
...
tip_mdf_brief[which(tip_mdf_brief$Country %in% 
                      c("India", "Nepal", "China", "Malaysia", "Thailand", "Cambodia", "Viet Nam", "Philippines",
...
#             file = "/full_path_to/wd/RdRp_scan/analysis/phylo/Negevirus_Tanay_clade/clades.tsv",
#             append = F, sep = "\t", col.names = T,
#             row.names = F, quote = F)
# 
# clades_df <- read_delim("/full_path_to/wd/RdRp_scan/analysis/phylo/Negevirus_Tanay_clade/clades.tsv", delim = '\t')
# 
...
ggt2_hm <- ggt2_hm + scale_fill_manual(breaks=c('Anopheles',
  ...
  # 'Culiseta',
  # 'Culex bitaeniorhynchus','Culex erythrothorax','Culex modestus','Culex nigropunctatus','Culex pipiens','Culex quinquefasciatus','Culex tarsalis','Culex theileri',
  'Culex',
  # 'Uranotaenia',
  'Psorophora',
...
values=c("black",
  ...
  # "#DDCC77",
  # "#392698", "#332288","#4b32c7","#634dd3", "#7f6dda", "#A89CE6","#9A8CE2","#8D7CDE",
  "#332288",
  # "#dd1c77",
  "#de2d26",
...
# 
# print(ggt2_hm)
ggt2_hm_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Negevirus_Tanay_clade/Negevirus_Tanay_clade1_aa_aln.ggtree_hm1.pdf"
ggsave(plot = ggt2_hm, filename = ggt2_hm_file, device = "pdf", width = 10, height = 10, units = "cm")

# ggt2_hm_file_legend <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Negevirus_Tanay_clade/Negevirus_Tanay_clade1_aa_aln.ggtree_hm_legend.pdf"
...
# print(ggt_sup2_hm)
ggt_sup2_hm_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Negevirus_Tanay_clade/Negevirus_Tanay_clade1_aa_aln.ggtree_hm_supplementary.pdf"
