...
################## Tree and metadata 
tree_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Negevirus_clade/tree/aa_tree/Negevirus_clade4_aa_aln_outg.fasta.gap50_clean.fasta.contree"
...
# gb_parse_gb_parsed_metadata_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Negevirus_clade/Negevirus_clade4_to_parse_metadata.gb"
# count = 0
# entry_ends = FALSE
# Location <- NULL
# host_taxon <- NULL
...
# 
# write.table(file = "/full_path_to/wd/RdRp_scan/analysis/phylo/Negevirus_clade/Negevirus_clade4_gb_parsed_metadata.txt",
#             x = gb_parsed_metadata, sep = "\t",append = F, quote = F,row.names = F, col.names = T)

gb_parsed_metadata <- read_delim("/full_path_to/wd/RdRp_scan/analysis/phylo/Negevirus_clade/Negevirus_clade4_gb_parsed_metadata.txt",
                                 delim = "\t")
...
tip_mdf_brief$host_taxon1 <- factor(tip_mdf_brief$host_taxon1, ordered = TRUE,
                                   levels = c('Culex annulirostris','Culex australicus','Culex gelidus','Culex globocoxitus','Culex inatomii','Culex modestus','Culex pipiens','Culex pseudovishnui',
                                              'Culex',
                                              'Aedes aegypti',
                                              'Culicidae',
                                              'Arthropoda'
...
ggt2_hm <- ggt2_hm + scale_fill_manual(breaks=c(# 'Anopheles',
  ...
  # 'Culiseta',
  'Culex annulirostris','Culex australicus','Culex gelidus','Culex globocoxitus','Culex inatomii','Culex modestus','Culex pipiens','Culex pseudovishnui',
  'Culex',
  # 'Uranotaenia',
  # 'Psorophora',
  
  'Aedes aegypti', 
  # 'Aedes albopictus', 'Aedes pseudoscutellaris',
  # 'Aedes',
  # 'Ochlerotatus',
...
# 
# print(ggt2_hm)
ggt2_hm_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Negevirus_clade/Negevirus_clade4_aa_aln.ggtree_hm1.pdf"
ggsave(plot = ggt2_hm, filename = ggt2_hm_file, device = "pdf", width = 10, height = 7, units = "cm")

# ggt2_hm_file_legend <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Negevirus_clade/Negevirus_clade4_aa_aln.ggtree_hm_legend.pdf"
...
# print(ggt_sup2_hm)
ggt_sup2_hm_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Negevirus_clade/Negevirus_clade4_aa_aln.ggtree_hm_supplementary.pdf"
