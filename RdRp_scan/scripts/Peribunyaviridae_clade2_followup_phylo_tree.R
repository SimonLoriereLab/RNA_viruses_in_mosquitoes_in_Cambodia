...
################## Tree and metadata 
tree_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Peribunyaviridae_clade/tree/aa_tree/Peribunyaviridae_clade2_aa_aln_outg.fasta.gap50_clean.fasta.contree"
...
tip_mdf_brief[which(tip_mdf_brief$nt_accession == "ON746425"),]$host_taxon <- "Haemaphysalis longicornis"
tip_mdf_brief[which(tip_mdf_brief$nt_accession == "ON125108"),]$host_taxon <- "macrophytes"
tip_mdf_brief[which(tip_mdf_brief$nt_accession == "MF190051"),]$host_taxon <- "Fucus serratus"
...
tip_mdf_brief[which(tip_mdf_brief$Country %in% 
                      c("Sweden", "Finland", "Spain", "Serbia", "Greece", "Hungary", "Germany", "Switzerland", "Italy")),
]$Region <- "Europe"
...
# 
# print(ggt2_hm)
ggt2_hm_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Peribunyaviridae_clade/Peribunyaviridae_clade2_aa_aln.ggtree_hm.pdf"
ggsave(plot = ggt2_hm, filename = ggt2_hm_file, device = "pdf", width = 10, height = 7, units = "cm")

# ggt2_hm_file_legend <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Peribunyaviridae_clade/Peribunyaviridae_clade2_aa_aln.ggtree_hm_legend.pdf"
...
# 
# print(ggt2_hm)
ggt2_hm_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Peribunyaviridae_clade/Peribunyaviridae_clade2_aa_aln.ggtree_hm1.pdf"
...
print(ggt_sup2_hm)
ggt_sup2_hm_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Peribunyaviridae_clade/Peribunyaviridae_clade2_aa_aln.ggtree_hm_supplementary.pdf"
