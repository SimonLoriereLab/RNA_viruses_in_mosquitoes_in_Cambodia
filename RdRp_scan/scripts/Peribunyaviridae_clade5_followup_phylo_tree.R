...
################## Tree and metadata 
tree_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Peribunyaviridae_clade/tree/aa_tree/Peribunyaviridae_clade5_aa_aln_outg.fasta.gap50_clean.fasta.contree"
...
###### Metadata
tip_mdf_brief <- read_delim("/full_path_to/wd/RdRp_scan/analysis/phylo/Peribunyaviridae_clade/updated_metadata_with_novel_seq1.txt", 
                  delim = "\t")
...
tip_mdf_brief[which(tip_mdf_brief$nt_accession == "ON860448"),]$host_taxon <- "Ochlerotatus communis"
tip_mdf_brief[which(tip_mdf_brief$nt_accession == "MG967338"),]$host_taxon <- "Blechomonas"
tip_mdf_brief[which(tip_mdf_brief$nt_accession == "KY322668"),]$host_taxon <- "Crithidia"
...
# tip_mdf_brief[which(tip_mdf_brief$host_taxon1 %in% c("Paris", "Vitis","Cladosporium","Erysiphe", "Plasmopara", 
#                                                      "Rhizoctonia", "Fucus", "Botrytis", "macrophytes", "Pestalotiopsis")), ]$host_taxon1 <- "Plantae/Fungi/Chromista"
# tip_mdf_brief[which(tip_mdf_brief$host_taxon1 %in% c("Dermacentor", "Ixodes", "Rhipicephalus", "Haemaphysalis")), ]$host_taxon1 <- "Ixodida"
tip_mdf_brief[which(tip_mdf_brief$host_taxon1 %in% c("Leptomonas", "Crithidia", "Blechomonas")), ]$host_taxon1 <- "Trypanosomatidae"
...
tip_mdf_brief[which(tip_mdf_brief$Country %in%
                      c("Colombia", "Brazil", "Peru", "Ecuador")),
]$Region <- "South America"

tip_mdf_brief[which(tip_mdf_brief$Country %in% 
                      c("Sweden", "Finland", "Spain", "Serbia", "Greece", "Hungary", "Czech Republic", "Germany", "Switzerland", "Italy")),
]$Region <- "Europe"
...
tip_mdf_brief[which(tip_mdf_brief$Country %in%
                      c("Kenya","Uganda", "Madagascar", "South Africa")),
]$Region <- "South, Southeast Africa"
...
#             file = "/full_path_to/wd/RdRp_scan/analysis/phylo/Peribunyaviridae_clade/clades.tsv",
#             append = F, sep = "\t", col.names = T,
#             row.names = F, quote = F)
# 
# clades_df <- read_delim("/full_path_to/wd/RdRp_scan/analysis/phylo/Peribunyaviridae_clade/clades.tsv", delim = '\t')
# 
...
ggt2_hm <- ggt2_hm + geom_point(data = ggt2_hm$data[which(!is.na(ggt2_hm$data$novel_seq)),],
                          aes( x = (extracted_xlims[2] - 0.6), y = y), 
                          color = "black",
                          size=1, shape = 8)
...
# 
# print(ggt2_hm)
ggt2_hm_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Peribunyaviridae_clade/Peribunyaviridae_clade5_aa_aln.ggtree_hm.pdf"
ggsave(plot = ggt2_hm, filename = ggt2_hm_file, device = "pdf", width = 10, height = 7, units = "cm")

# ggt2_hm_file_legend <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Peribunyaviridae_clade/Peribunyaviridae_clade5_aa_aln.ggtree_hm_legend.pdf"
...
ggt2_hm <- gheatmap(ggt2, genus_matrix, offset=2, width=0.24, font.size=2,
                    colnames_angle=-90, hjust=0)
...
# 
# print(ggt2_hm)
ggt2_hm_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Peribunyaviridae_clade/Peribunyaviridae_clade5_aa_aln.ggtree_hm1.pdf"
ggsave(plot = ggt2_hm, filename = ggt2_hm_file, device = "pdf", width = 20, height = 7, units = "cm")
...
print(ggt_sup2_hm)
ggt_sup2_hm_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Peribunyaviridae_clade/Peribunyaviridae_clade5_aa_aln.ggtree_hm_supplementary.pdf"
