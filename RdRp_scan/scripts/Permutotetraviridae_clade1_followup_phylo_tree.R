...
################## Tree and metadata 
tree_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Permutotetraviridae_clade/tree/aa_tree/Permutotetraviridae_clade1_aa_aln_outg.fasta.gap50_clean.fasta.contree"
...
###### Metadata
tip_mdf_brief <- read_delim("/full_path_to/wd/RdRp_scan/analysis/phylo/Permutotetraviridae_clade/updated_metadata_with_novel_seq1.txt", 
                  delim = "\t")
...
# gb_parse_gb_parsed_metadata_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Permutotetraviridae_clade/Permutotetraviridae_clade1_to_parse_metadata.gb"
# count = 0
# entry_ends = FALSE
# Location <- NULL
# host_taxon <- NULL
...
# 
# write.table(file = "/full_path_to/wd/RdRp_scan/analysis/phylo/Permutotetraviridae_clade/Permutotetraviridae_clade1_gb_parsed_metadata.txt",
#             x = gb_parsed_metadata, sep = "\t",append = F, quote = F,row.names = F, col.names = T)

gb_parsed_metadata <- read_delim("/full_path_to/wd/RdRp_scan/analysis/phylo/Permutotetraviridae_clade/Permutotetraviridae_clade1_gb_parsed_metadata.txt",
                                 delim = "\t")
...
tip_mdf_brief[which(tip_mdf_brief$nt_accession == 'NC_030845'),]$host_taxon <- 'Insecta'
tip_mdf_brief[which(tip_mdf_brief$nt_accession == 'MZ218708'),]$host_taxon <- 'soil'
tip_mdf_brief[which(tip_mdf_brief$nt_accession == 'MZ218721'),]$host_taxon <- 'soil'
tip_mdf_brief[which(tip_mdf_brief$nt_accession == 'MZ218726'),]$host_taxon <- 'soil'
tip_mdf_brief[which(tip_mdf_brief$nt_accession == 'MZ218732'),]$host_taxon <- 'sediment'
tip_mdf_brief[which(tip_mdf_brief$nt_accession == 'MZ218742'),]$host_taxon <- 'soil'
tip_mdf_brief[which(tip_mdf_brief$nt_accession == 'MZ218743'),]$host_taxon <- 'cattle feces'
...
#             file = "/full_path_to/wd/RdRp_scan/analysis/phylo/Permutotetraviridae_clade/clades.tsv",
#             append = F, sep = "\t", col.names = T,
#             row.names = F, quote = F)
# 
# clades_df <- read_delim("/full_path_to/wd/RdRp_scan/analysis/phylo/Permutotetraviridae_clade/clades.tsv", delim = '\t')
# 
...
ggt2_hm <- ggt2_hm + scale_fill_manual(breaks=c('Anopheles',
                                                ...
                                                # 'Wyeomyia', ### Same color as either Sabethes or Armigeres unless two or more are present
                                                # 'Mansonia',
                                                'Coquillettidia',
...
# 
# print(ggt2_hm)
ggt2_hm_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Permutotetraviridae_clade/Permutotetraviridae_clade1_aa_aln.ggtree_hm.pdf"
ggsave(plot = ggt2_hm, filename = ggt2_hm_file, device = "pdf", width = 20, height = 14, units = "cm")

# ggt2_hm_file_legend <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Permutotetraviridae_clade/Permutotetraviridae_clade1_aa_aln.ggtree_hm_legend.pdf"
...
# 
# print(ggt2_hm)
ggt2_hm_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Permutotetraviridae_clade/Permutotetraviridae_clade1_aa_aln.ggtree_hm1.pdf"
...
print(ggt_sup2_hm)
ggt_sup2_hm_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Permutotetraviridae_clade/Permutotetraviridae_clade1_aa_aln.ggtree_hm_supplementary.pdf"
