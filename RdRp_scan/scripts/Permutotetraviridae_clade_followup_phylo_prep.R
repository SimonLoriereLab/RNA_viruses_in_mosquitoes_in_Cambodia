...
Permutotetraviridae_clade_df <- read_delim("/full_path_to/wd/RdRp_scan/analysis/phylo/Permutotetraviridae_clade/Permutotetraviridae_clade_novel_sequence_data.txt")
...
read_map_df_Permutotetraviridae_clade <- read_map_df[which(read_map_df$ref_id %in% Permutotetraviridae_clade_df$contig_id & read_map_df$selected == "yes"),]



read_map_df_Permutotetraviridae_clade$RdRp_scan_map_consensus_id <- paste0(read_map_df_Permutotetraviridae_clade$ref_id, "_",
                      read_map_df_Permutotetraviridae_clade$sample_id, "_RdRpScan_Round1")

read_map_df_Permutotetraviridae_clade$contig_id <- read_map_df_Permutotetraviridae_clade$ref_id

consensus_df <- left_join(read_map_df_Permutotetraviridae_clade, Permutotetraviridae_clade_df, by  = "contig_id")
...
extracted_consensus_directory <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Permutotetraviridae_clade/extracted_cons1_renamed/"
dir.create(extracted_consensus_directory)
extracted_orf_nt_directory <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Permutotetraviridae_clade/extracted_cons1_orf_nt/"
dir.create(extracted_orf_nt_directory)
extracted_orf_aa_directory <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Permutotetraviridae_clade/extracted_cons1_orf_aa/"
...
write.table(x = consensus_df, file = "/full_path_to/wd/RdRp_scan/analysis/phylo/Permutotetraviridae_clade/consensus_df.txt", 
...
write.table(x = novel_seq_mdf1, file = "/full_path_to/wd/RdRp_scan/analysis/phylo/Permutotetraviridae_clade/updated_consensus_df.txt", 
            append = F, quote = F, sep = "\t", row.names = F, col.names = T)
...
# orf_aa_w_stops <- seqinr::read.fasta(file = "/full_path_to/wd/RdRp_scan/analysis/phylo/Permutotetraviridae_clade/Permutotetraviridae_orf_aa_manually_corrected.fasta",
#                                      seqtype = "AA")
# extracted_orf_aa_directory1 <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Permutotetraviridae_clade/extracted_cons1_orf_aa_corrected/"
...
#                       file.out = paste0("/full_path_to/wd/RdRp_scan/analysis/phylo/Permutotetraviridae_clade/extracted_cons1_orf_aa_corrected/",
#                                         n, ".fasta"))
# }
...
web_blastp_df <- read_delim("/full_path_to/wd/RdRp_scan/analysis/phylo/Permutotetraviridae_clade/ZVZW821R013-Alignment.txt", 
...
rdrp_scan_clade_accns <- str_remove(str_remove(str_split(consensus_df$ref_suggestions, ",")[[1]], "[[:print:]]+Permutotetraviridae_"), "\\.[[:digit:]]{1}\\_[[:print:]]+$")
...
#### Reimport metadata
NCBI_Virus_mdf <- read_csv("/full_path_to/wd/RdRp_scan/analysis/phylo/Permutotetraviridae_clade/Permutotetraviridae_metadata_public.csv")
...
write.table(x = selected_mdf_upd_novel, file = "/full_path_to/wd/RdRp_scan/analysis/phylo/Permutotetraviridae_clade/updated_metadata_with_novel_seq.txt", 
            append = F, quote = F, sep = "\t", row.names = F, col.names = T)
...
# refs <- read_lines("/full_path_to/wd/RdRp_scan/analysis/phylo/Permutotetraviridae_clade/Permutotetraviridae_accessions_viruses.txt")
...
#### Put the file here!
cds_fasta_file1 <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Permutotetraviridae_clade/Permutotetraviridae_clade_refs_cds_nt1.txt"
cds_fasta_file2 <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Permutotetraviridae_clade/Permutotetraviridae_clade_refs_cds_nt2.txt"
cds_fasta_file3 <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Permutotetraviridae_clade/Permutotetraviridae_clade_refs_cds_nt3.txt"
cds_fasta_file4 <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Permutotetraviridae_clade/Permutotetraviridae_clade_refs_cds_nt4.txt"
...
############################################################################################
############################################################################################
cds_clade_dir <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Permutotetraviridae_clade/ref_cds_nt"
dir.create(cds_clade_dir)
aa_clade_dir <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Permutotetraviridae_clade/ref_cds_aa"
...
### ignoring these 
### "4XHA_A" "7OM2_A" as well as the ones with no accession
...
# gb_parse_metadata_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Permutotetraviridae_clade/Permutotetraviridae_to_parse_metadata.gb"
# count = 0
# entry_ends = FALSE
...
write.table(x = selected_mdf_upd_novel1, file = "/full_path_to/wd/RdRp_scan/analysis/phylo/Permutotetraviridae_clade/updated_metadata_with_novel_seq1.txt", 
            append = F, quote = F, sep = "\t", row.names = F, col.names = T)
...
#### Permutotetraviridae_clade1 tree
Permutotetraviridae_clade1_str <- "MZ218742_Permutotetraviridae_sp_
OL700211_XiangYun_permutotetra-like_virus
MZ209846_Sanya_permutotetravirus_1
MZ209962_Sanya_permutotetravirus_1
Hubei_permutotetra_like_virus_2_F1357C9F1357
Hubei_permutotetra_like_virus_2_F1357C9F1441
KX883455_Hubei_permutotetra-like_virus_2
NC_033121_Hubei_permutotetra-like_virus_2
MZ218732_Permutotetraviridae_sp_
MT753154_Sanxia_permutotetra-like_virus_1
NC_033188_Sanxia_permutotetra-like_virus_1
MZ209963_Sanya_permutotetravirus_2
KX883446_Hubei_permutotetra-like_virus_1
KX883457_Hubei_permutotetra-like_virus_1
NC_033105_Hubei_permutotetra-like_virus_1
KX883448_Hubei_permutotetra-like_virus_1
MZ218708_Permutotetraviridae_sp_
MZ209964_Sanya_permutotetravirus_3
MZ218721_Permutotetraviridae_sp_
MZ218726_Permutotetraviridae_sp_
NC_033470_Wuhan_house_centipede_virus_9
Sarawak_virus_F1348C1F1006
Sarawak_virus_F1348C1F1508
OP858841_Sarawak_virus
NC_040540_Sarawak_virus
NC_040795_Shinobi_tetravirus
Sarawak_virus_F1348C1F1348
Sarawak_virus_F1348C1F1346
Sarawak_virus_F1348C1F1183
LC536111_Permutotetraviridae_sp_
Culex_permutotetra_like_virus_F1052C13C663F1276
Culex_permutotetra_like_virus_F1052C13C663F1052
Culex_permutotetra_like_virus_F1052C13C663F1322
Culex_permutotetra_like_virus_F1052C13C663F1332
LC505019_Culex_permutotetra-like_virus
MH384302_Newfield_virus
MH384307_Newfield_virus
KP714070_Newfield_virus
MZ218743_Permutotetraviridae_sp_
NC_033179_Hubei_permutotetra-like_virus_3
"
Permutotetraviridae_clade1 <- str_split(Permutotetraviridae_clade1_str, "\\s")[[1]]
Permutotetraviridae_clade1 <- Permutotetraviridae_clade1[which(!Permutotetraviridae_clade1 == "")]

Permutotetraviridae_clade_aa1_seq <- seqinr::read.fasta(file = "/full_path_to/wd/RdRp_scan/analysis/phylo/Permutotetraviridae_clade/aln/aa_seq/Permutotetraviridae_clade_aa.fasta",
                                seqtype = "AA")
Permutotetraviridae_clade1_aa_seq <- Permutotetraviridae_clade_aa1_seq[Permutotetraviridae_clade1]
names(Permutotetraviridae_clade1_aa_seq)
seqinr::write.fasta(sequences = Permutotetraviridae_clade1_aa_seq , names =names(Permutotetraviridae_clade1_aa_seq),
                    file.out = "/full_path_to/wd/RdRp_scan/analysis/phylo/Permutotetraviridae_clade/aln/aa_seq/Permutotetraviridae_clade1_aa.fasta")
##keep the closest sequence as an outgroup
new_outg <- "NC_030845_Egaro_virus"
new_outg_seq <- Permutotetraviridae_clade_aa1_seq[new_outg]
seqinr::write.fasta(sequences = new_outg_seq , names =names(new_outg_seq),
                    file.out = paste0("/full_path_to/wd/RdRp_scan/analysis/phylo/Permutotetraviridae_clade/aln/aa_seq/",
                                      new_outg, ".fasta"))
