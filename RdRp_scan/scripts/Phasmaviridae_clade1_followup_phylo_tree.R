...
################## Tree and metadata 
tree_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Phasmaviridae_clade/tree/aa_tree/Phasmaviridae_clade1_aa_aln_outg.fasta.gap50_clean.fasta.contree"
...
###### Metadata
tip_mdf_brief <- read_delim("/full_path_to/wd/RdRp_scan/analysis/phylo/Phasmaviridae_clade/updated_metadata_with_novel_seq1.txt", 
                  delim = "\t")
...
tip_mdf_brief[which(tip_mdf_brief$nt_accession == "NC_040462"),]$host_taxon <- "Diadegma fenestrale"
tip_mdf_brief[which(tip_mdf_brief$nt_accession == "NC_038706"),]$host_taxon <- "Culicidae"
tip_mdf_brief[which(tip_mdf_brief$nt_accession == "KP710233"),]$host_taxon <- "Culicidae"
tip_mdf_brief[which(tip_mdf_brief$nt_accession == "KP710249"),]$host_taxon <- "Culicidae"
tip_mdf_brief[which(tip_mdf_brief$nt_accession == "KP710255"),]$host_taxon <- "Culicidae"
tip_mdf_brief[which(tip_mdf_brief$nt_accession == "KP710256"),]$host_taxon <- "Culicidae"
tip_mdf_brief[which(tip_mdf_brief$nt_accession == "KP710257"),]$host_taxon <- "Culicidae"
...
tip_mdf_brief[which(tip_mdf_brief$host_taxon1 %in% c("Acanthosoma", "Acyrthosiphon", 
                                                     ...
                                                     "Tetrodontophora", "Urbanus")), ]$host_taxon1 <- "Insecta (-Culicidae)"
...
#             file = "/full_path_to/wd/RdRp_scan/analysis/phylo/Phasmaviridae_clade/clades.tsv",
#             append = F, sep = "\t", col.names = T,
#             row.names = F, quote = F)
# 
# clades_df <- read_delim("/full_path_to/wd/RdRp_scan/analysis/phylo/Phasmaviridae_clade/clades.tsv", delim = '\t')
# 
...
# 
# print(ggt2_hm)
ggt2_hm_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Phasmaviridae_clade/Phasmaviridae_clade1_aa_aln.ggtree_hm.pdf"
ggsave(plot = ggt2_hm, filename = ggt2_hm_file, device = "pdf", width = 10, height = 14, units = "cm")

# ggt2_hm_file_legend <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Phasmaviridae_clade/Phasmaviridae_clade1_aa_aln.ggtree_hm_legend.pdf"
...
# 
# print(ggt2_hm)
ggt2_hm_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Phasmaviridae_clade/Phasmaviridae_clade1_aa_aln.ggtree_hm1.pdf"
ggsave(plot = ggt2_hm, filename = ggt2_hm_file, device = "pdf", width = 10, height = 14, units = "cm")
...
print(ggt_sup2_hm)
ggt_sup2_hm_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Phasmaviridae_clade/Phasmaviridae_clade1_aa_aln.ggtree_hm_supplementary.pdf"
