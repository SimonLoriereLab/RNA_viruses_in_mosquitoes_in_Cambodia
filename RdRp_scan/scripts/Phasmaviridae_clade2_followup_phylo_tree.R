...
################## Tree and metadata 
tree_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Phasmaviridae_clade/tree/aa_tree/Phasmaviridae_clade2_aa_aln_outg.fasta.gap50_clean.fasta.contree"
...
tip_mdf_brief[which(tip_mdf_brief$nt_accession == "MN168168"),]$host_taxon <- "Chaoborus americanus"
...
tip_mdf_brief[which(tip_mdf_brief$host_taxon1 %in% c("Insecta","Diptera","Calliphora", "Bactrocera", "Eristalis", "Apis", "Acanthosoma", "Acyrthosiphon", 
                                                     ...
                                                     "Tetrodontophora", "Urbanus", "Ferdinandea", "Pectinophora")), ]$host_taxon1 <- "Insecta"
...
# 
# print(ggt2_hm)
ggt2_hm_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Phasmaviridae_clade/Phasmaviridae_clade2_aa_aln.ggtree_hm.pdf"
ggsave(plot = ggt2_hm, filename = ggt2_hm_file, device = "pdf", width = 10, height = 14, units = "cm")

# ggt2_hm_file_legend <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Phasmaviridae_clade/Phasmaviridae_clade2_aa_aln.ggtree_hm_legend.pdf"
...
# 
# print(ggt2_hm)
ggt2_hm_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Phasmaviridae_clade/Phasmaviridae_clade2_aa_aln.ggtree_hm1.pdf"
ggsave(plot = ggt2_hm, filename = ggt2_hm_file, device = "pdf", width = 10, height = 14, units = "cm")
...
print(ggt_sup2_hm)
ggt_sup2_hm_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Phasmaviridae_clade/Phasmaviridae_clade2_aa_aln.ggtree_hm_supplementary.pdf"
