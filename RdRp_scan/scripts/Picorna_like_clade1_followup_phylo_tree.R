...
################## Tree and metadata 
tree_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Picorna_like_clade/tree/aa_tree/Picorna_like_clade1_aa_aln_outg.fasta.gap50_clean.fasta.contree"
...
###### Metadata
tip_mdf_brief <- read_delim("/full_path_to/wd/RdRp_scan/analysis/phylo/Picorna_like_clade/updated_metadata_with_novel_seq1.txt", 
                  delim = "\t")
...
#             file = "/full_path_to/wd/RdRp_scan/analysis/phylo/Picorna_like_clade/clades.tsv",
#             append = F, sep = "\t", col.names = T,
#             row.names = F, quote = F)
# 
# clades_df <- read_delim("/full_path_to/wd/RdRp_scan/analysis/phylo/Picorna_like_clade/clades.tsv", delim = '\t')
# 
...
# 
# print(ggt2_hm)
ggt2_hm_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Picorna_like_clade/Picorna_like_clade1_aa_aln.ggtree_hm.pdf"
ggsave(plot = ggt2_hm, filename = ggt2_hm_file, device = "pdf", width = 10, height = 5, units = "cm")

# ggt2_hm_file_legend <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Picorna_like_clade/Picorna_like_clade1_aa_aln.ggtree_hm_legend.pdf"
...
# 
# print(ggt2_hm)
ggt2_hm_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Picorna_like_clade/Picorna_like_clade1_aa_aln.ggtree_hm1.pdf"
...
print(ggt_sup2_hm)
ggt_sup2_hm_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Picorna_like_clade/Picorna_like_clade1_aa_aln.ggtree_hm_supplementary.pdf"
