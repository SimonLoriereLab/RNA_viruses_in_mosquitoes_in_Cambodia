...
Picorna_like_clade_df <- read_delim("/full_path_to/wd/RdRp_scan/analysis/phylo/Picorna_like_clade/Picorna_like_clade_novel_sequence_data.txt")
...
read_map_df_Picorna_like_clade <- read_map_df[which(read_map_df$ref_id %in% Picorna_like_clade_df$contig_id & read_map_df$selected == "yes"),]



read_map_df_Picorna_like_clade$RdRp_scan_map_consensus_id <- paste0(read_map_df_Picorna_like_clade$ref_id, "_",
                      read_map_df_Picorna_like_clade$sample_id, "_RdRpScan_Round1")

read_map_df_Picorna_like_clade$contig_id <- read_map_df_Picorna_like_clade$ref_id

consensus_df <- left_join(read_map_df_Picorna_like_clade, Picorna_like_clade_df, by  = "contig_id")
...
extracted_consensus_directory <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Picorna_like_clade/extracted_cons1_renamed/"
dir.create(extracted_consensus_directory)
extracted_orf_nt_directory <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Picorna_like_clade/extracted_cons1_orf_nt/"
dir.create(extracted_orf_nt_directory)
extracted_orf_aa_directory <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Picorna_like_clade/extracted_cons1_orf_aa/"
...
write.table(x = consensus_df, file = "/full_path_to/wd/RdRp_scan/analysis/phylo/Picorna_like_clade/consensus_df.txt", 
...
write.table(x = novel_seq_mdf1, file = "/full_path_to/wd/RdRp_scan/analysis/phylo/Picorna_like_clade/updated_consensus_df.txt", 
            append = F, quote = F, sep = "\t", row.names = F, col.names = T)
...
# orf_aa_w_stops <- seqinr::read.fasta(file = "/full_path_to/wd/RdRp_scan/analysis/phylo/Picorna_like_clade/Picorna_like_orf_aa_manually_corrected.fasta",
#                                      seqtype = "AA")
# extracted_orf_aa_directory1 <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Picorna_like_clade/extracted_cons1_orf_aa_corrected/"
...
#                       file.out = paste0("/full_path_to/wd/RdRp_scan/analysis/phylo/Picorna_like_clade/extracted_cons1_orf_aa_corrected/",
#                                         n, ".fasta"))
# }
...
web_blastp_df <- read_delim("/full_path_to/wd/RdRp_scan/analysis/phylo/Picorna_like_clade/VS12EFV5016-Alignment.txt", 
...
#### Reimport metadata
NCBI_Virus_mdf <- read_csv("/full_path_to/wd/RdRp_scan/analysis/phylo/Picorna_like_clade/Picorna_like_metadata_public.csv")
...
write.table(x = selected_mdf_upd_novel, file = "/full_path_to/wd/RdRp_scan/analysis/phylo/Picorna_like_clade/updated_metadata_with_novel_seq.txt", 
            append = F, quote = F, sep = "\t", row.names = F, col.names = T)
...
#### Put the file here!
cds_fasta_file1 <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Picorna_like_clade/Picorna_like_clade_refs_cds_nt.txt"
# cds_fasta_file2 <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Picorna_like_clade/Picorna_like_clade_refs_cds_nt2.txt"
...
############################################################################################
############################################################################################
cds_clade_dir <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Picorna_like_clade/ref_cds_nt"
dir.create(cds_clade_dir)
aa_clade_dir <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Picorna_like_clade/ref_cds_aa"
...
# gb_parse_metadata_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Picorna_like_clade/Picorna_like_to_parse_metadata.gb"
# count = 0
# entry_ends = FALSE
...
write.table(x = selected_mdf_upd_novel1, file = "/full_path_to/wd/RdRp_scan/analysis/phylo/Picorna_like_clade/updated_metadata_with_novel_seq1.txt", 
            append = F, quote = F, sep = "\t", row.names = F, col.names = T)
...
#### Picorna_like_clade1 tree
Picorna_like_clade1_str <- "MH703052_Yongsan_picorna-like_virus_2
OL700096_Yongsan_picorna-like_virus_2
MH703060_Yongsan_picorna-like_virus_2
MW650740_Ecclesville_picorna-like_virus
MN661035_Atrato_picorna-like_virus_1
Zhejiang_mosquito_virus_1_F1605C1F1035
Zhejiang_mosquito_virus_1_F1605C1F1613
Zhejiang_mosquito_virus_1_F1605C1F1043
Zhejiang_mosquito_virus_1_F1605C1F1044
Zhejiang_mosquito_virus_1_F1605C1F1605
Zhejiang_mosquito_virus_1_F1605C1F1466
MW452304_Riboviria_sp_
Zhejiang_mosquito_virus_1_F1605C1F1047
Zhejiang_mosquito_virus_1_F1605C1F1046
KX883285_Zhejiang_mosquito_virus_1
NC_033716_Zhejiang_mosquito_virus_1
MN784075_Old_Port_virus
MN784077_Old_Port_virus
MN784076_Old_Port_virus
MN784073_Old_Port_virus
MN784074_Old_Port_virus
Yongsan_picorna_like_virus_2_F1457C1F1409
Yongsan_picorna_like_virus_2_F1457C1F1457
OP264911_Yongsan_picorna-like_virus_2
MN661036_Atrato_picorna-like_virus_1
MW650741_Ecclesville_picorna-like_virus
"
Picorna_like_clade1 <- str_split(Picorna_like_clade1_str, "\\s")[[1]]
Picorna_like_clade1 <- Picorna_like_clade1[which(!Picorna_like_clade1 == "")]

Picorna_like_clade_aa_seq <- seqinr::read.fasta(file = "/full_path_to/wd/RdRp_scan/analysis/phylo/Picorna_like_clade/aln/aa_seq/Picorna_like_clade_aa.fasta",
                                seqtype = "AA")
Picorna_like_clade1_aa_seq <- Picorna_like_clade_aa_seq[Picorna_like_clade1]
names(Picorna_like_clade1_aa_seq)
seqinr::write.fasta(sequences = Picorna_like_clade1_aa_seq , names =names(Picorna_like_clade1_aa_seq),
                    file.out = "/full_path_to/wd/RdRp_scan/analysis/phylo/Picorna_like_clade/aln/aa_seq/Picorna_like_clade1_aa.fasta")
##keep the closest sequence as an outgroup
new_outg <- "MZ209811_Guiyang_Solinvi-like_virus_3"
new_outg_seq <- Picorna_like_clade_aa_seq[new_outg]
seqinr::write.fasta(sequences = new_outg_seq , names =names(new_outg_seq),
                    file.out = paste0("/full_path_to/wd/RdRp_scan/analysis/phylo/Picorna_like_clade/aln/aa_seq/",
                                      new_outg, ".fasta"))
