...
################## Tree and metadata 
tree_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Reovirales_clade/tree/aa_tree/Reovirales_clade1_aa_aln_outg.fasta.gap50_clean.fasta.contree"
...
###### Metadata
tip_mdf_brief <- read_delim("/full_path_to/wd/RdRp_scan/analysis/phylo/Reovirales_clade/updated_metadata_with_novel_seq1.txt", 
                  delim = "\t")
...
tip_mdf_brief[which(tip_mdf_brief$nt_accession == "NC_007667"),]$host_taxon <- "Aedes pseudoscutellaris"
...
tip_mdf_brief$host_taxon1 <- factor(tip_mdf_brief$host_taxon1, ordered = TRUE,
                                   levels = c('Culex erythrothorax', 'Culex pipiens', 'Culex quinquefasciatus',
                                     'Culex',
                                     'Aedes aegypti',
                                     'Aedes albopictus',
...
#             file = "/full_path_to/wd/RdRp_scan/analysis/phylo/Reovirales_clade/clades.tsv",
#             append = F, sep = "\t", col.names = T,
#             row.names = F, quote = F)
# 
# clades_df <- read_delim("/full_path_to/wd/RdRp_scan/analysis/phylo/Reovirales_clade/clades.tsv", delim = '\t')
# 
...
# 
# print(ggt2_hm)
ggt2_hm_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Reovirales_clade/Reovirales_clade1_aa_aln.ggtree_hm.pdf"
ggsave(plot = ggt2_hm, filename = ggt2_hm_file, device = "pdf", width = 20, height = 14, units = "cm")

# ggt2_hm_file_legend <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Reovirales_clade/Reovirales_clade1_aa_aln.ggtree_hm_legend.pdf"
...
# 
# print(ggt2_hm)
ggt2_hm_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Reovirales_clade/Reovirales_clade1_aa_aln.ggtree_hm1.pdf"
ggsave(plot = ggt2_hm, filename = ggt2_hm_file, device = "pdf", width = 20, height = 14, units = "cm")
...
print(ggt_sup2_hm)
ggt_sup2_hm_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Reovirales_clade/Reovirales_clade1_aa_aln.ggtree_hm_supplementary.pdf"
