...
################## Tree and metadata 
tree_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Reovirales_clade/tree/aa_tree/Reovirales_clade2_aa_aln_outg.fasta.gap50_clean.fasta.contree"
...
tip_mdf_brief$host_taxon1 <- factor(tip_mdf_brief$host_taxon1, ordered = TRUE,
                                   levels = c('Culex gelidus', 'Culex pipiens',
                                     'Aedes aegypti',
                                     'Aedes caecus',
                                     'Ochlerotatus',
                                     'Culicinae',
...
ggt2_hm <- ggt2_hm + scale_fill_manual(breaks=c(# 'Anopheles',
                                                ...
                                                # 'Culiseta',
                                                'Culex gelidus', 'Culex pipiens',
                                                # 'Culex',
                                                # 'Uranotaenia',
                                                # 'Psorophora',

                                                'Aedes aegypti', 'Aedes caecus',
                                                # 'Aedes',
                                                'Ochlerotatus',
...
# 
# print(ggt2_hm)
ggt2_hm_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Reovirales_clade/Reovirales_clade2_aa_aln.ggtree_hm.pdf"
ggsave(plot = ggt2_hm, filename = ggt2_hm_file, device = "pdf", width = 20, height = 14, units = "cm")

# ggt2_hm_file_legend <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Reovirales_clade/Reovirales_clade2_aa_aln.ggtree_hm_legend.pdf"
...
# 
# print(ggt2_hm)
ggt2_hm_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Reovirales_clade/Reovirales_clade2_aa_aln.ggtree_hm1.pdf"
ggsave(plot = ggt2_hm, filename = ggt2_hm_file, device = "pdf", width = 20, height = 14, units = "cm")
...
print(ggt_sup2_hm)
ggt_sup2_hm_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Reovirales_clade/Reovirales_clade2_aa_aln.ggtree_hm_supplementary.pdf"
