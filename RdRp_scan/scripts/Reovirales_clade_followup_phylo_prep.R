...
Reovirales_clade_df <- read_delim("/full_path_to/wd/RdRp_scan/analysis/phylo/Reovirales_clade/Reovirales_clade_novel_sequence_data.txt")
...
read_map_df_Reovirales_clade <- read_map_df[which(read_map_df$ref_id %in% Reovirales_clade_df$contig_id & read_map_df$selected == "yes"),]



read_map_df_Reovirales_clade$RdRp_scan_map_consensus_id <- paste0(read_map_df_Reovirales_clade$ref_id, "_",
                      read_map_df_Reovirales_clade$sample_id, "_RdRpScan_Round1")

read_map_df_Reovirales_clade$contig_id <- read_map_df_Reovirales_clade$ref_id

consensus_df <- left_join(read_map_df_Reovirales_clade, Reovirales_clade_df, by  = "contig_id")
...
extracted_consensus_directory <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Reovirales_clade/extracted_cons1_renamed/"
dir.create(extracted_consensus_directory)
extracted_orf_nt_directory <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Reovirales_clade/extracted_cons1_orf_nt/"
dir.create(extracted_orf_nt_directory)
extracted_orf_aa_directory <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Reovirales_clade/extracted_cons1_orf_aa/"
...
write.table(x = consensus_df, file = "/full_path_to/wd/RdRp_scan/analysis/phylo/Reovirales_clade/consensus_df.txt", 
...
write.table(x = novel_seq_mdf1, file = "/full_path_to/wd/RdRp_scan/analysis/phylo/Reovirales_clade/updated_consensus_df.txt", 
            append = F, quote = F, sep = "\t", row.names = F, col.names = T)
...
# orf_aa_w_stops <- seqinr::read.fasta(file = "/full_path_to/wd/RdRp_scan/analysis/phylo/Reovirales_clade/Reovirales_orf_aa_manually_corrected.fasta",
#                                      seqtype = "AA")
# extracted_orf_aa_directory1 <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Reovirales_clade/extracted_cons1_orf_aa_corrected/"
...
#                       file.out = paste0("/full_path_to/wd/RdRp_scan/analysis/phylo/Reovirales_clade/extracted_cons1_orf_aa_corrected/",
#                                         n, ".fasta"))
# }
# 
...
web_blastp_df <- read_delim("/full_path_to/wd/RdRp_scan/analysis/phylo/Reovirales_clade/VXMWKRN2013-Alignment.txt", 
...
rdrp_scan_clade_accns <- str_remove(str_remove(str_split(consensus_df$ref_suggestions, ",")[[1]], "[[:print:]]+Reovirales_"), "\\.[[:digit:]]{1}\\_[[:print:]]+$")
...
rdrp_scan_clade_accns <- rdrp_scan_clade_accns[which(!rdrp_scan_clade_accns %in% c("Yunnan_2_reo_like_virus", 
                                                                                   "Sichuan_29_reo_like_virus_5",
                                                                                   "Jiangsu_6_reo_like_virus_2"))]
...
#### Reimport metadata
NCBI_Virus_mdf <- read_csv("/full_path_to/wd/RdRp_scan/analysis/phylo/Reovirales_clade/Reovirales_metadata_public.csv")
...
write.table(x = selected_mdf_upd_novel, file = "/full_path_to/wd/RdRp_scan/analysis/phylo/Reovirales_clade/updated_metadata_with_novel_seq.txt", 
            append = F, quote = F, sep = "\t", row.names = F, col.names = T)
...
refs <- read_lines("/full_path_to/wd/RdRp_scan/analysis/phylo/Reovirales_clade/Reovirales_accessions_viruses.txt")
...
#### Put the file here!
cds_fasta_file1 <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Reovirales_clade/Reovirales_clade_refs_cds_nt.txt"
# cds_fasta_file2 <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Reovirales_clade/Reovirales_clade_refs_cds_nt2.txt"
...
############################################################################################
############################################################################################
cds_clade_dir <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Reovirales_clade/ref_cds_nt"
dir.create(cds_clade_dir)
aa_clade_dir <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Reovirales_clade/ref_cds_aa"
...
# gb_parse_metadata_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Reovirales_clade/Reovirales_to_parse_metadata.gb"
# count = 0
# entry_ends = FALSE
...
write.table(x = selected_mdf_upd_novel1, file = "/full_path_to/wd/RdRp_scan/analysis/phylo/Reovirales_clade/updated_metadata_with_novel_seq1.txt", 
            append = F, quote = F, sep = "\t", row.names = F, col.names = T)
...
#### Reovirales_clade1 tree
Reovirales_clade1_str <- "MK133927_Hubei_reo-like_virus_7
MK133926_Hubei_reo-like_virus_7
MK133928_Hubei_reo-like_virus_7
MK133925_Hubei_reo-like_virus_7
MK133924_Hubei_reo-like_virus_7
MK133923_Hubei_reo-like_virus_7
KX884635_Hubei_reo-like_virus_7
OL700066_Hubei_reo-like_virus_7
Hubei_reo_like_virus_7_F1429C41F1429
OP264886_Hubei_reo-like_virus_7
MW434750_Elemess_virus
MW434753_Elemess_virus
MW434751_Elemess_virus
MW434752_Elemess_virus
KM978416_Fako_virus
NC_025486_Fako_virus
OP264919_Fako_virus
LC496849_Aedes_pseudoscutellaris_reovirus
NC_007667_Aedes_pseudoscutellaris_reovirus
Forfical_virus_F1194C164F1194
Forfical_virus_F1194C164F1197
Forfical_virus_F1194C164F1183
KX884633_Hubei_mosquito_virus_5
"
Reovirales_clade1 <- str_split(Reovirales_clade1_str, "\\s")[[1]]
Reovirales_clade1 <- Reovirales_clade1[which(!Reovirales_clade1 == "")]

Reovirales_clade_aa_seq <- seqinr::read.fasta(file = "/full_path_to/wd/RdRp_scan/analysis/phylo/Reovirales_clade/aln/aa_seq/Reovirales_clade_aa.fasta",
                                seqtype = "AA")
Reovirales_clade1_aa_seq <- Reovirales_clade_aa_seq[Reovirales_clade1]
names(Reovirales_clade1_aa_seq)
seqinr::write.fasta(sequences = Reovirales_clade1_aa_seq , names =names(Reovirales_clade1_aa_seq),
                    file.out = "/full_path_to/wd/RdRp_scan/analysis/phylo/Reovirales_clade/aln/aa_seq/Reovirales_clade1_aa.fasta")
##keep the closest sequence as an outgroup
new_outg <- "NC_027567_Lutzomyia_reovirus_1"
new_outg_seq <- Reovirales_clade_aa_seq[new_outg]
seqinr::write.fasta(sequences = new_outg_seq , names =names(new_outg_seq),
                    file.out = paste0("/full_path_to/wd/RdRp_scan/analysis/phylo/Reovirales_clade/aln/aa_seq/",
                                      new_outg, ".fasta"))



####### Zooming in on different clades
#### Reovirales_clade2 tree
Reovirales_clade2_str <- "KF298273_uncultured_virus
MW434754_Lasigmu_virus
BK059491_Aedes_orbi-like_virus
Erroyantry_virus_F1102C96F1102
MT822189_Serbia_reo-like_virus_1
Eshizing_virus_F1187C97F1187
"
Reovirales_clade2 <- str_split(Reovirales_clade2_str, "\\s")[[1]]
Reovirales_clade2 <- Reovirales_clade2[which(!Reovirales_clade2 == "")]

Reovirales_clade_aa_seq <- seqinr::read.fasta(file = "/full_path_to/wd/RdRp_scan/analysis/phylo/Reovirales_clade/aln/aa_seq/Reovirales_clade_aa.fasta",
                                              seqtype = "AA")
Reovirales_clade2_aa_seq <- Reovirales_clade_aa_seq[Reovirales_clade2]
names(Reovirales_clade2_aa_seq)
seqinr::write.fasta(sequences = Reovirales_clade2_aa_seq , names =names(Reovirales_clade2_aa_seq),
                    file.out = "/full_path_to/wd/RdRp_scan/analysis/phylo/Reovirales_clade/aln/aa_seq/Reovirales_clade2_aa.fasta")
##keep the closest sequence as an outgroup
new_outg <- "KX884702_Hubei_reo-like_virus_14"
new_outg_seq <- Reovirales_clade_aa_seq[new_outg]
seqinr::write.fasta(sequences = new_outg_seq , names =names(new_outg_seq),
                    file.out = paste0("/full_path_to/wd/RdRp_scan/analysis/phylo/Reovirales_clade/aln/aa_seq/",
                                      new_outg, ".fasta"))
