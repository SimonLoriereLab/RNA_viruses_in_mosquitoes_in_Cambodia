...
Tymovirales_clade_df <- read_delim("/full_path_to/wd/RdRp_scan/analysis/phylo/Tymovirales_clade/Tymovirales_clade_novel_sequence_data.txt")
...
read_map_df_Tymovirales_clade <- read_map_df[which(read_map_df$ref_id %in% Tymovirales_clade_df$contig_id & read_map_df$selected == "yes"),]



read_map_df_Tymovirales_clade$RdRp_scan_map_consensus_id <- paste0(read_map_df_Tymovirales_clade$ref_id, "_",
                      read_map_df_Tymovirales_clade$sample_id, "_RdRpScan_Round1")

read_map_df_Tymovirales_clade$contig_id <- read_map_df_Tymovirales_clade$ref_id

consensus_df <- left_join(read_map_df_Tymovirales_clade, Tymovirales_clade_df, by  = "contig_id")
...
extracted_consensus_directory <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Tymovirales_clade/extracted_cons1_renamed/"
dir.create(extracted_consensus_directory)
extracted_orf_nt_directory <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Tymovirales_clade/extracted_cons1_orf_nt/"
dir.create(extracted_orf_nt_directory)
extracted_orf_aa_directory <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Tymovirales_clade/extracted_cons1_orf_aa/"
...
write.table(x = consensus_df, file = "/full_path_to/wd/RdRp_scan/analysis/phylo/Tymovirales_clade/consensus_df.txt", 
...
write.table(x = novel_seq_mdf1, file = "/full_path_to/wd/RdRp_scan/analysis/phylo/Tymovirales_clade/updated_consensus_df.txt", 
            append = F, quote = F, sep = "\t", row.names = F, col.names = T)
...
# orf_aa_w_stops <- seqinr::read.fasta(file = "/full_path_to/wd/RdRp_scan/analysis/phylo/Tymovirales_clade/Tymovirales_orf_aa_manually_corrected.fasta",
#                                      seqtype = "AA")
# extracted_orf_aa_directory1 <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Tymovirales_clade/extracted_cons1_orf_aa_corrected/"
...
#                       file.out = paste0("/full_path_to/wd/RdRp_scan/analysis/phylo/Tymovirales_clade/extracted_cons1_orf_aa_corrected/",
#                                         n, ".fasta"))
# }
# 
...
web_blastp_df <- read_delim("/full_path_to/wd/RdRp_scan/analysis/phylo/Tymovirales_clade/ZTD23HBW013-Alignment.txt", 
...
rdrp_scan_clade_accns <- str_remove(str_remove(str_split(consensus_df$ref_suggestions, ",")[[1]], "[[:print:]]+Tymovirales_"), "\\.[[:digit:]]{1}\\_[[:print:]]+$")
...
#### Reimport metadata
NCBI_Virus_mdf <- read_csv("/full_path_to/wd/RdRp_scan/analysis/phylo/Tymovirales_clade/Tymovirales_metadata_public.csv")
...
write.table(x = selected_mdf_upd_novel, file = "/full_path_to/wd/RdRp_scan/analysis/phylo/Tymovirales_clade/updated_metadata_with_novel_seq.txt", 
            append = F, quote = F, sep = "\t", row.names = F, col.names = T)
...
# refs <- read_lines("/full_path_to/wd/RdRp_scan/analysis/phylo/Tymovirales_clade/Tymovirales_accessions_viruses.txt")
...
#### Put the file here!
cds_fasta_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Tymovirales_clade/Tymovirales_clade_refs_cds_nt.txt"
...
############################################################################################
############################################################################################
cds_clade_dir <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Tymovirales_clade/ref_cds_nt"
dir.create(cds_clade_dir)
aa_clade_dir <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Tymovirales_clade/ref_cds_aa"
...
# gb_parse_metadata_file <- "/full_path_to/wd/RdRp_scan/analysis/phylo/Tymovirales_clade/Tymovirales_to_parse_metadata.gb"
# count = 0
# entry_ends = FALSE
...
write.table(x = selected_mdf_upd_novel1, file = "/full_path_to/wd/RdRp_scan/analysis/phylo/Tymovirales_clade/updated_metadata_with_novel_seq1.txt", 
            append = F, quote = F, sep = "\t", row.names = F, col.names = T)
...
#### Tymovirales_clade1 tree
Tymovirales_clade1_str <- "MN053826_Guadeloupe_Culex_tymo-like_virus
MN053827_Guadeloupe_Culex_tymo-like_virus
MN053825_Guadeloupe_Culex_tymo-like_virus
Guadeloupe_Culex_tymo_like_virus_F1120C2F1120
Guadeloupe_Culex_tymo_like_virus_F1120C2F1117
Guadeloupe_Culex_tymo_like_virus_F1120C2F1116
MH188018_Culex_originated_Tymoviridae-like_virus
MN510431_Culex_originated_Tymoviridae-like_virus
MW434965_Guadeloupe_Culex_tymo-like_virus
MZ556262_Sichuan_mosquito_tymo-like_virus
OL700056_Guadeloupe_Culex_tymo-like_virus
MW452308_Tymoviridae_sp_
MK440641_Tarnsjo_virus
MK440631_Tarnsjo_virus
LC512732_Culex_pseudovishnui_tymo-like_virus
MT435496_Gonipterus_platensis_Macula-Like_virus
MW864076_Tymoviridae_sp__XZN137671
MW520376_Xanthi_tymo-likevirus
"
Tymovirales_clade1 <- str_split(Tymovirales_clade1_str, "\\s")[[1]]
Tymovirales_clade1 <- Tymovirales_clade1[which(!Tymovirales_clade1 == "")]

Tymovirales_clade_aa1_seq <- seqinr::read.fasta(file = "/full_path_to/wd/RdRp_scan/analysis/phylo/Tymovirales_clade/aln/aa_seq/Tymovirales_clade_aa.fasta",
                                seqtype = "AA")
Tymovirales_clade1_aa_seq <- Tymovirales_clade_aa1_seq[Tymovirales_clade1]
names(Tymovirales_clade1_aa_seq)
seqinr::write.fasta(sequences = Tymovirales_clade1_aa_seq , names =names(Tymovirales_clade1_aa_seq),
                    file.out = "/full_path_to/wd/RdRp_scan/analysis/phylo/Tymovirales_clade/aln/aa_seq/Tymovirales_clade1_aa.fasta")
##keep the closest sequence as an outgroup
new_outg <- "MZ556269_Sichuan_mosquito_tymo-like_virus"
new_outg_seq <- Tymovirales_clade_aa1_seq[new_outg]
seqinr::write.fasta(sequences = new_outg_seq , names =names(new_outg_seq),
                    file.out = paste0("/full_path_to/wd/RdRp_scan/analysis/phylo/Tymovirales_clade/aln/aa_seq/",
                                      new_outg, ".fasta"))
